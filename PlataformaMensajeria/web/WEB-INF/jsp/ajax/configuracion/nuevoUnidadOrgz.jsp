...
<s:form id="frmSaveUnidadOrg" method="POST" action="saveUnidadOrg" validate="false"  theme="css_xhtml">
<fieldset>
		...
		<tr>
			...
			<td headers="header0"><s:textfield
				name="unidadOrganizacional.nombre" 
				value="%{unidadOrganizacional.nombre}" 
				id="unidadOrganizacional.nombre"
				theme="xhtml" 
		...
		<tr>
			...
			<td headers="header0">
			<framework:catalog 
				catalogname="comunidades" 
				headerKey="-1" 
				headerValue=""
				dependentDropdownList="unidadOrganizacional.provincia,provinciasPorCA"
				id="unidadOrganizacional.comunidades" 
				name="unidadOrganizacional.comunidad" 
				value="%{unidadOrganizacional.comunidad}"
				key="field.test.ca" 
				labelposition="left" 
				required="true" 
				theme="xhtml"
		...
		<tr>
			...
			<framework:catalog 
				...
				id="unidadOrganizacional.provincia" 
				name="unidadOrganizacional.provincia" 
				value="%{unidadOrganizacional.provincia}"
				key="field.test.prov" 
				labelposition="left" 
				required="true" 
				theme="xhtml"
		...
		<tr>
			...
			<td headers="header0">
			<framework:catalog  
				id="unidadOrganizacional.localidad" 
				name="unidadOrganizacional.localidad" 
				value="%{unidadOrganizacional.localidad}"
...
<br>
	<div><s:url id="urlV" action="manageUnidadOrg" />
	<s:a href="%{urlV}" 
		labelposition="left">
