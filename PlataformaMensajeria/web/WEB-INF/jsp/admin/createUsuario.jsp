...
<s:form id="frmCrearUsuario" method="POST" action="adminAltaUsuario"
		...
		<tbody>
			<tr>
				...
				<td headers="header0"><s:select
					id="form.tipoUsuario" name="form.tipoUsuario" 
				...
				<td headers="header0"><s:textfield
					...
					key="field.usuario.username" labelposition="left" /></td>
			</tr>
			<tr>
				<!-- nombre -->
				<td headers="header0"><s:textfield
