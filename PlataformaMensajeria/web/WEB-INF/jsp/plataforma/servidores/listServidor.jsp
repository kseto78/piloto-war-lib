	...
	<s:form id="frmBuscarServidores" method="POST" action="buscarServidores" validate="false" theme="css_xhtml">
		<div class="criteria">
			<p class="criteria">
				...
				<s:textfield name="servidor.nombre" id="servidor.nombre" theme="simple" key="field.general.nombre" labelposition="left" required="false" size="100" cssStyle="width:500px;" maxlength="255" cssClass="input_tablas_registro" />
			</p>
