		...
		<div class="editContent">
			<s:form id="formaddServidorOrganismo" theme="simple" validate="false"
				...
				<p class="criteria">
					...
					<span> <label style="width: 100px;" class="fieldText">Nº
							reintentos (*):</label> <s:textfield name="servidorOrganismo.numIntentos"
							value="%{servidorOrganismo.numIntentos}"
							id="servidorOrganismo.numIntentos" theme="simple"
							onKeyPress="return numbersonly(this, event)" labelposition="left"
							title="Nº Reintentos" size="4" maxlength="255" cssClass="" />
