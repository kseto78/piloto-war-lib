                  ...
                  <p class="criteria">
                 	...
                 	<span>
						...
						<s:textfield
								...
								cssClass="datepicker">
								<s:param name="value">
    							<s:date name="gestionEnvioHistoricoBean.fechaDesde" format="dd/MM/yyyy"/>
  						</s:param>
						</s:textfield>
                        Fecha Fin: <s:textfield
								...
								cssClass="datepicker">
						<s:param name="value">
    						<s:date name="gestionEnvioHistoricoBean.fechaHasta" format="dd/MM/yyyy"/>
  						</s:param>
						</s:textfield>
                    </span>
                    <span>
