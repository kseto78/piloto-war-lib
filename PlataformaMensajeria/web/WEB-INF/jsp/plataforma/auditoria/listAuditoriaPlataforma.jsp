		...
		<s:form id="frmBuscarPlanificaciones" method="POST"
			...
			<p class="criteria">
				<span> <label style="width: 100px;" class="fieldText">Entidad:</label>
					...
					<s:textfield name="auditoriaPlataforma.adtUsuario"
						...
						labelposition="left" required="false" size="100"
			...
			<p class="criteria">
				<span> <label class="fieldText" style="width: 100px;">
						Fecha: </label>Desde: <s:textfield name="auditoriaPlataforma.fechaDesde"
						...
						id="auditoriaPlataforma.fechaDesde" theme="simple" format="dd/MM/yyyy"
						style="width:60px;" size="10" maxlength="10" cssClass="datepicker">
						<s:param name="value">
    							<s:date name="auditoriaPlataforma.fechaDesde" format="dd/MM/yyyy"/>
  						</s:param>
						</s:textfield>
					Hasta: <s:textfield name="auditoriaPlataforma.fechaHasta"
						value="%{auditoriaPlataforma.fechaHasta}"
						id="auditoriaPlataforma.fechaHasta" theme="simple"
						onchange="validateDates('auditoriaPlataforma.fechaDesde','auditoriaPlataforma.fechaHasta',this)"
						style="width:60px;" size="10" maxlength="10" cssClass="datepicker">
						<s:param name="value">
    							<s:date name="auditoriaPlataforma.fechaHasta" format="dd/MM/yyyy"/>
  						</s:param>
						</s:textfield>
				</span> <span> <label style="width: 100px;" class="fieldText">Operación:</label>
