...
<s:url id="url" action="updatePlanificacionApp"/>
		...
		<s:form id="updatePlanificacion" name="updatePlanificacion" theme="simple" action="updatePlanificacionReceptorSMS">
            ...
            <%@include file="/WEB-INF/jsp/plataforma/validation/validadoresJS.jsp" %>
					        ...
					        <div class="editContent">
					                   ...
					                   <p class="criteria">
					                    ...
					                    <input type="hidden" name="idReceptorSMS" id="idReceptorSMS" value="${idReceptorSMS}"/>
