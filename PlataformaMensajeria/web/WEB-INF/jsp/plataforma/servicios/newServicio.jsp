	...
	<s:form id="frmNuevoServicio" method="POST" action="saveServicio"
		...
		<div class="editContainer">
			...
			<div class="editContent">
				...
				<p class="criteria">
					<label id="endPointLabel" style="width: 120px; visibility: hidden;display:none"
						class="fieldText">EndPoint (*):</label>
					<s:textfield name="servicio.endPoint" value="%{servicio.endPoint}"
						id="servicio.endPoint" theme="simple" cssStyle="visibility:hidden;display:none"
						labelposition="left" size="70" maxlength="255" cssClass="" />
				</p>
