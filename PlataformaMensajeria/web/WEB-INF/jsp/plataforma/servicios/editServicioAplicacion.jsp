...
<div class="mainContent">            
		...
		<%@include file="/WEB-INF/jsp/plataforma/validation/fieldErrorForm.jsp" %>
            ...
            <div class="editContainer">
				...
				<p class="criteria">
					<label id="fromMailLabel" style="width: 140px; visibility: hidden;"
				...
				<p class="criteria">
					<label id="fromMailNameLabel"
						style="width: 140px; visibility: hidden;" class="fieldText">Nombre
                    ...
                    <p class="criteria">
                        <label id="endPointLabel" style="width: 120px;" class="fieldText">EndPoint (*):</label>
                         <s:textfield
                    ...
                    <p class="criteria">
                        <label id="nombreLoteEnvioLabel" style="width: 121px;visibility:hidden" class="fieldText">Nombre Lote Envío (*):</label>
						<s:textfield
                    ...
                    <p class="criteria">
                        <label id="badgeLabel" style="width: 180px;visibility:hidden" class="fieldText">Agrupar notificaciones cada (*):</label>
                        <s:textfield
                    ...
                    <p class="criteria">
                        <label id="gcmProjectKeyLabel" style="width: 180px;visibility:hidden" class="fieldText">GCM API Key (*):</label>
                        <s:textfield
                     ...
                     <p class="criteria">
                        <label id="apnsRutaCertificadoLabel" style="width: 180px;visibility:hidden" class="fieldText">APNS Ruta Certificado (*):</label>
                        <s:textfield
                     ...
                     <p class="criteria">
                        <label id="apnsPasswordCertificadoLabel" style="width: 179px;visibility:hidden" class="fieldText">APNS Password Certificado (*):</label>
                        <s:password
