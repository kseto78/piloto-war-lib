...
/**
 * Clase ProcesoInformesServiciosBean.
 *
 * @author jgonzvil
 * @version 1.0
 */
public class ProcesoInformesServiciosBean implements Audit{
	 ...
	 *
	 * @return proceso informes servicios id
	 */
	...
	/**
	 * Modificar proceso informes servicios id.
	 *
	 * @param procesoInformesServiciosId new proceso informes servicios id
	 */
