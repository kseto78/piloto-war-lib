...
<plataforma:securityRedirect isAction="true"
	...
	<div class="editContainer">
		<div style="width: 135px" class="nameDescription">
			<label style="text-align: center;">Arbol de Organismos Pdp</label>		
		</div>
		<div style="width: 770px;padding-left:15%" class="editContent" >
			...
			<s:else>			
				<ul class="tree">			
					<b><s:label theme="simple" id="organismo" name="organismo" value="%{organismo.nombre}" style="margin-left:130px" />									
