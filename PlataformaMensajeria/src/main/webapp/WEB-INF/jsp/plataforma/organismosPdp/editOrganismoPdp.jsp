...
<div class="mainContent">
	...
	<s:form id="frmEditOrganismo" method="POST" action="updateOrganismoPdp"
		...
		<h3 class="pageNameButtons">
			<span class="floatRight"> <s:submit theme="simple"
				...
				value="Volver">
			</span> <label>EDICIÓN ORGANISMOS PDP</label>
		</h3>
		...
		<div class="editContainer">
			...
			<div class="editContent">
				<s:hidden theme="simple" id="organismo.organismoPdpId"
						name="organismo.organismoPdpId" value="%{organismo.organismoPdpId}" />
				<s:hidden theme="simple" id="idOrganismo" name="idOrganismo"
						value="%{organismo.organismoPdpId}" />						
					<p class="criteria">
				...
				<p class="criteria">
					...
					<span style="width: 300px;"> <label style="width: 145px;"
						class="fieldText">Servidor / Proveedor:</label> <s:select
							...
							name="servidorOrganismo" id="servidorOrganismo" value="%{idOrganismo}" />
...
function loadArbol(enlace) {
	var idOrganismo = document.getElementById('idOrganismo').value;
	...
	var url = "arbolOrganismoPdpSeleccion.action?idOrganismo=" + idOrganismo + "&arbol=true";
	 ...
	 var dialogoTree = $('#dialogTree');
	    dialogoTree.load(
                ...
                function(responseText, textStatus, XMLHttpRequest) {
   	    			...
   	    			if(!responseText.includes("El organismo pdp seleccionado no tiene ningun organismo asociado")){
...
function loadArbolServidor(enlace) {
	...
	var url = "arbolOrganismoPdpSeleccionServidor.action?idOrganismo=" + idOrganismo + "&arbol=true";
