...
<s:url id="url" action="updatePlanificacionApp"/>
		...
		<s:form id="updatePlanificacion" name="updatePlanificacion" theme="simple" action="updatePlanificacionServer">
            ...
            <%@include file="/WEB-INF/jsp/plataforma/validation/validadoresJS.jsp" %>
					        ...
					        <div class="editContent">
					                   ...
					                   <p class="criteria">
					                    ...
					                    <input type="hidden" name="idServidor" id="idServidor" value="${idServidor}"/>
