...
<s:url id="url" action="updatePlanificacionApp"/>
		...
		<s:form id="updatePlanificacion" name="updatePlanificacion" theme="simple" action="updatePlanificacionProveedorSMS">
            ...
            <%@include file="/WEB-INF/jsp/plataforma/validation/validadoresJS.jsp" %>
					        ...
					        <div class="editContent">
					                   ...
					                   <p class="criteria">
					                    ...
					                    <input type="hidden" name="idProveedorSMS" id="idProveedorSMS" value="${idProveedorSMS}"/>
