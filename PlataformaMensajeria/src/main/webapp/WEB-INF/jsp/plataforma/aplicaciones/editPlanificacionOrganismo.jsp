...
<s:url id="url" action="updatePlanificacionApp"/>
		...
		<s:form id="updatePlanificacion" name="updatePlanificacion" theme="simple" action="updatePlanificacionOrganismo">
            ...
            <%@include file="/WEB-INF/jsp/plataforma/validation/validadoresJS.jsp" %>
					        ...
					        <div class="editContent">
					                   ...
					                   <p class="criteria">
					                    ...
					                    <input type="hidden" name="planificacion.organismoId" id="planificacion.organismoId" 
					                    		value="${planificacion.organismoId}"/>
					                    	
					                    <input type="hidden" name="idPlanificacion" id="idPlanificacion" value="${planificacion.planificacionId}"/>
					                    <input type="hidden" name="idOrganismo" id="idOrganismo" value="${planificacion.organismoId}"/>
