...
<s:url id="url" action="updatePlanificacionApp"/>
		...
		<s:form id="updatePlanificacion" name="updatePlanificacion" theme="simple" action="updatePlanificacionServidorWebPush">
            		...
            		<%@include file="/WEB-INF/jsp/plataforma/validation/validadoresJS.jsp" %>
					        ...
					        <div class="editContent">
					                   ...
					                   <input type="hidden" name="idServidorWebPush" id="idServidorWebPush" value="${idServidorWebPush}"/>
