...
<div id="Lote" class="ui-dialog-content ui-widget-content" style="display: block; min-height: 0px; height: auto;">
    ...
    <s:if test="#total > 20">
     ...
     <s:if test="#total < 20">
	    ...
	    <display:table 
					...
					name="listaGestionEnviosMensajes" 
					pagesize="${pageSize}"
					requestURI="viewLote.action" 
					defaultsort="1" 
					...
					<%-- acciones --%>
					<display:column property="gestionLotesAction"  titleKey="plataforma.gestionViewLotes.blanco" 
