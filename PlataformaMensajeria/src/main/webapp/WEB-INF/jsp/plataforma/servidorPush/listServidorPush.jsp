...
<div class="mainContent">
	...
	<%@include file="/WEB-INF/jsp/plataforma/validation/fieldErrorForm.jsp" %>	
            <div class="criteria">
		<s:form id="frmBuscarServidorPush" method="POST" action="buscarServidorPush"
		validate="false" theme="css_xhtml">            	
            	<p class="criteria">
                    <label class="fieldText" style="width: 100px;">Nombre:</label>
                    <s:textfield
							name="servidorPush.nombre" id="servidorPush.nombre"
							theme="simple" 
		...
		<s:form id="frmEliminarServidoresPushSeleccionados" method="POST" onsubmit="return confirmDeleteSelected();" action="deleteServidoresPushSeleccionados">
		   ...
		   <table class="tablaHeader">
			<thead>
               ...
               <script>
               	function checkBotonEliminarSeleccionados(){
               		var listaChecks = document.getElementById('frmEliminarServidoresPushSeleccionados').checkDelList;
			...
			<display:table 
				...
				<display:column class="darkTD TH15">
					...
					<input type="checkbox" onclick="checkBotonEliminarSeleccionados()" id="checkDelList" name="checkDelList" value="${tableId.servidorPushId }"/></center> 
					<input type="hidden" idd="__checkbox_checkDelList" name="__checkbox_checkDelList"/>
 				
				</display:column>
				<display:column property="servidorPushId" titleKey="field.servidorPush.id" sortable="false"
				...
				<display:column property="isActivo" titleKey="field.servidorPush.activo" sortable="false"
					headerClass="TH50 separator center" class="center" />
				<%-- acciones --%>
				<display:column property="servidorPushAction"  
				...
				<tr>
                    	<td colspan="5">
		                    ...
		                    <span class="rightSide">
                            	...
                            	<input  type="button" value="Nueva Entrada" class="button" onclick='javascript:location.href="nuevoServidorPush.action"'/>
                            </span>
                        </td>
                    </tr>
               </tfoot>
