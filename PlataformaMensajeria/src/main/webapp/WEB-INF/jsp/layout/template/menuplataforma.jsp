...
<div class="menu">
	<plataforma:securityadmin usuarioLogueado="true"
		showIfNotGranted="false" showIfGranted="true">
		<div>
			<h3 id="desplegable0">
				<a href="home.action">Escritorio</a>
			</h3>
		</div>
	...
	<plataforma:securityadmin usuarioLogueado="true" showIfGranted="true">
		...
		<div>
			<h3>
				<span onclick="fncDesplegarMenu(1);" class="menuDesplegable">Configuración
					General</span>
			</h3>
			<div id="desplegable1">
				<ul>
					<li><a href="buscarServidores.action" id="desplegable11"
						class="servSMTP">Servidores SMTP</a></li>
					<li><a href="buscarProveedorSMS.action" id="desplegable12"
						class="ProveSMS">Proveedores SMS</a></li>
					<li><a href="buscarProveedoresMisim.action" id="desplegable13"
						class="RecepSMS">Proveedores MISIM</a></li>
					<li><a href="buscarReceptorSMS.action" id="desplegable14"
						class="RecepSMS">Receptores SMS</a></li>
					<li><a href="buscarServidorPush.action" id="desplegable15"
						class="RecepSMS">Servidores Push</a></li>
					<li><a href="buscarServidorWebPush.action" id="desplegable16"
						class="RecepSMS">Servidores Web Push</a></li>
				</ul>
			</div>

			<h3>
				<span onclick="fncDesplegarMenu(2);" class="menuDesplegable">Configuración
					Aplicaciones</span>
			</h3>
			<div id="desplegable2">
				<!-- 						<div id="desplegable2">  -->
				<ul>
					<li><a href="buscarAplicaciones.action" id="desplegable21"
						class="Aplicaciones">Aplicaciones</a></li>
					<li><a href="buscarServicios.action" id="desplegable22"
						class="Servicios">Servicios</a></li>
					<li><a href="buscarPlanificaciones.action" id="desplegable23"
						class="Planificaciones">Planificaciones</a></li>
					<li><a href="buscarServiciosMoviles.action" id="desplegable25"
						class="Servicios">Servicios Moviles</a>
				</ul>
			</div>
			<h3>
				<span onclick="fncDesplegarMenu(3)" class="menuDesplegable">Configuración
					Seguridad</span>
			</h3>
			<div id="desplegable3">
				<!-- 						<div id="desplegable3"> -->
				<ul>
					<li><a href="buscarUsuarios.action" id="desplegable31"
						class="Usuarios">Usuarios</a></li>
					<!--<li><a href="../../Seguridad/Roles/Creacion.html" class="Roles">Roles</a></li>-->
				</ul>
			</div>
			<h3>
				<span onclick="fncDesplegarMenu(20)" class="menuDesplegable">Configuración
					Organismos</span>
			</h3>
			<div id="desplegable20">
				<ul>
					<li><a href="listarOrganismos.action" id="desplegable201"
						class="Usuarios">Organismos</a></li>

					<li><a href="altasMasivasOrganismosView.action"
	...
	<plataforma:securityadmin usuarioLogueado="true"
		showIfNotGranted="true" showIfGranted="false">
		<h2>gestión</h2>
		<div>
			<h3 id="desplegable6">
				<a href="buscarGestionEnvios.action">Gestión de Envíos</a>
			</h3>

			<h3 id="desplegable7">
				<a href="buscarEstadisticas.action">Estadísticas Generales</a>
			</h3>

			<h3 id="desplegable8">
				<a href="buscarUsuariosPush.action">Usuarios Push</a>
			</h3>

			<h3 id="desplegable9">
				<a href="buscarUsuariosWebPush.action">Usuarios Web Push</a>
			</h3>

			<h3 id="desplegable10">
				<a href="envioMensajesHome.action">Envío de Mensajes</a>
			</h3>
			<!-- <ul>
	...
	<div>
		<ul>
			...
			<s:iterator value="%{listaAplicacionesUsuario}" var="ap"
				...
				<li><a id='${ap.aplicacionId}'
					href="viewAplicacion.action?idAplicacion=${ap.aplicacionId}"
					class="BBDD060">${ap.nombre}</a></li>
			</s:iterator>
...
<script language="Javascript">
	window.onload = new function cargar() {
		...
		if (url.endsWith('infoHome.action')) {
			...
			menu1 = 20;
		} else if (url.endsWith('buscarServiciosMoviles.action')
				|| url.includes('ServicioMovil.action')) {
			...
			elem1.style.backgroundColor = "#003366";
			menu1 = 4;
		} else if (url.includes('ejecucionJob.action')) {
			elem1 = document.getElementById('desplegable42');
			elem1.style.backgroundColor = "#003366";
			menu1 = 4;
			...
			elem1.style.backgroundColor = "#003366";
			menu1 = 4;
		} else if (url.endsWith('envioMensajesHome.action')
				|| url.endsWith('envioMensajesAplicacion.action')) {
			elem1 = document.getElementById('desplegable10');
			elem1.style.backgroundColor = "#003366";
			menu1 = 4;
		} else if (url.includes('viewAplicacion.action')) {

			var el = document.getElementById("listaAplicacionesUsuario")
					.getElementsByTagName("aplicacionId");
