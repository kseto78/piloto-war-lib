...
public class TableWrapper extends TableDecorator {
	...
	public String getGestionEnviosAction() {
		...
		if (null == gestionEnvioBean.getMensajeId() || gestionEnvioBean.getMensajeId() == 0) {
			...
			String btnAjax = "<div id=\"ajaxloader_ajax_" + gestionEnvioBean.getId() + "\"><span class=\"btnView gestionEnvio_link\" title=\"Ver\" onclick=\"return loadLote(this,'" + gestionEnvioBean.getIdLote() + "','" + tipoEnvio + "')\" name=\"ajax\" id=\"ajax_" + gestionEnvioBean
					.getIdLote() + "\"></span><div>";
			return btnAjax;
		} else if(null != gestionEnvioBean.getVistaEnviosId() && gestionEnvioBean.getVistaEnviosId().equals(3)){
			String tipoEnvio = "viewHistorico";
			String btnAjax = "<div id=\"ajaxloader_ajax_historico" + gestionEnvioBean.getMensajeId() + "\"><span class=\"btnView gestionEnvio_link\" title=\"Ver\" onclick=\"return loadMensajeHistorico(this,'" + gestionEnvioBean.getMensajeId() + "','" + tipoEnvio + "','" + gestionEnvioBean.getDestinatariosMensajes() + "',' ')"
					+ "\" name=\"ajax\" id=\"ajax_historico" + gestionEnvioBean.getDestinatariosMensajes() + "\"></span><div>";
			return btnAjax;
		}else{
			String tipoMensaje = "";
			switch (gestionEnvioBean.getCanalId()) {
			case 1:
				tipoMensaje = "EMAIL";
				break;
			case 2:
			...
			String btnAjax = "<div id=\"ajaxloader_ajax_" + gestionEnvioBean.getId() + "\"><span class=\"btnView gestionEnvio_link\" title=\"Ver\" onclick=\"return loadMensaje(this,'" + gestionEnvioBean.getMensajeId() + "','" + tipoEnvio + "','" + tipoMensaje + "','" + gestionEnvioBean
	...
	public String getGestionEnviosHistoricosAction() {
		...
		// filtrado por lotes
				if (null == gestionEnvioHistoricoBean.getMensajeId() || gestionEnvioHistoricoBean.getMensajeId() == 0) {
					...
					String btnAjax = "<div id=\"ajaxloader_ajax_" + gestionEnvioHistoricoBean.getId() + "\"><span class=\"btnView gestionEnvio_link\" title=\"Ver\" onclick=\"return loadLoteHist(this,'" + gestionEnvioHistoricoBean.getIdLote() + "','" + tipoEnvio + "')\" name=\"ajax\" id=\"ajax_" + gestionEnvioHistoricoBean
							.getIdLote() + "\"></span><div>";
					return btnAjax;
					...
					String btnAjax = "<div id=\"ajaxloader_ajax_historico" + gestionEnvioHistoricoBean.getMensajeId() + "\"><span class=\"btnView gestionEnvio_link\" title=\"Ver\" onclick=\"return loadMensajeHistorico(this,'" + gestionEnvioHistoricoBean.getMensajeId() + "','" + tipoEnvio + "','" + gestionEnvioHistoricoBean.getDestinatariosMensajes() + "',' ')"
							+ "\" name=\"ajax\" id=\"ajax_historico" + gestionEnvioHistoricoBean.getDestinatariosMensajes() + "\"></span><div>";
					return btnAjax;
				} else {
					String tipoMensaje = "";
					switch (gestionEnvioHistoricoBean.getCanalId()) {
					case 1:
						tipoMensaje = "EMAIL";
						break;
					case 2:
					...
					String tipoEnvio = "viewMensaje";
					String btnAjax = "<div id=\"ajaxloader_ajax_" + gestionEnvioHistoricoBean.getId() + "\"><span class=\"btnView gestionEnvio_link\" title=\"Ver\" onclick=\"return loadMensajeHist(this,'" + gestionEnvioHistoricoBean.getMensajeId() + "','" + tipoEnvio + "','" + tipoMensaje + "','" + gestionEnvioHistoricoBean
