 ...
 */
@Entity
@Table(name = "TBL_GESTIONENVIOS_HIST")
@NamedQueries({         
	@NamedQuery(name = "selectAllGestionEnviosHistoricosJPA", query = "SELECT e FROM GestionEnviosHistoricosJPA e")})

public class GestionEnviosHistoricosJPA extends AbstractBaseJPAEntity implements Serializable {
	...
	public GestionEnviosHistoricosJPA() {
