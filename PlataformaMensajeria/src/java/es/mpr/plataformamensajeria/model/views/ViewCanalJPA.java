...
@NamedQueries({         
	@NamedQuery(name = "selectViewCanalesJPA", query = "SELECT e FROM ViewCanalJPA e order by e.nombre")})

public class ViewCanalJPA extends AbstractBaseJPAEntity implements Serializable {
