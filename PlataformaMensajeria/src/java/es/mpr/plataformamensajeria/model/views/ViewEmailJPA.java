 ...
 */
@Entity
@Table(name = "VIEW_EMAILS")
@NamedQueries({         
	@NamedQuery(name = "selectAllViewEmailJPA", query = "SELECT e FROM ViewEmailJPA e"),
	@NamedQuery(name = "selectViewEmailJPA", query = "SELECT e FROM ViewEmailJPA e where e.emailId=:emailId")})

public class ViewEmailJPA extends AbstractBaseJPAEntity implements Serializable {
