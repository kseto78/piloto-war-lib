 ...
 */
@Entity
@Table(name = "VIEW_GESTIONSMS")
@NamedQueries({         
	@NamedQuery(name = "selectAllViewSMSJPA", 
			query = "SELECT e FROM ViewSMSJPA e"),
	@NamedQuery(name = "selectViewSMSJPA", 
			query = "SELECT e FROM ViewSMSJPA e where e.idEnviosSMS=:idEnvioSMS")})

public class ViewSMSJPA extends AbstractBaseJPAEntity implements Serializable {
