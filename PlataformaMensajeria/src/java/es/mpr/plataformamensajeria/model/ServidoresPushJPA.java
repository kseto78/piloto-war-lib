...
@NamedQueries({
	@NamedQuery(name = "selectServidoresPushJPA", query = "SELECT e FROM ServidoresPushJPA e WHERE upper (e.nombre) like :nombre and" +
			" e.tipo = :tipo and (e.eliminado is null or e.eliminado = 'N')"),
	@NamedQuery(name= "selectServidoresPushByName_orderbyNombre_ASC", query="SELECT e FROM ServidoresPushJPA e WHERE upper (e.nombre) like :nombre and" +
			" e.tipo = :tipo and (e.eliminado is null or e.eliminado = 'N') order by e.nombre ASC"),
	@NamedQuery(name= "selectServidoresPushByName_orderbyNombre_DESC", query="SELECT e FROM ServidoresPushJPA e WHERE upper (e.nombre) like :nombre and" +
			" e.tipo = :tipo and (e.eliminado is null or e.eliminado = 'N') order by e.nombre DESC"),
	@NamedQuery(name= "selectServidoresPushByName_orderbyDescripcion_ASC", query="SELECT e FROM ServidoresPushJPA e WHERE upper (e.nombre) like :nombre and" +
			" e.tipo = :tipo and (e.eliminado is null or e.eliminado = 'N') order by e.descripcion ASC"),
	@NamedQuery(name= "selectServidoresPushByName_orderbyDescripcion_DESC", query="SELECT e FROM ServidoresPushJPA e WHERE upper (e.nombre) like :nombre and" +
			" e.tipo = :tipo and (e.eliminado is null or e.eliminado = 'N') order by e.descripcion DESC"),
	@NamedQuery(name = "selectServidoresPush_orderbyId_ASC", query = "SELECT e FROM ServidoresPushJPA e WHERE upper (e.nombre) like :nombre and" +
			" e.tipo = :tipo and (e.eliminado is null or e.eliminado = 'N') order by e.id ASC"),
	@NamedQuery(name = "selectServidoresPush_orderbyNombre_ASC", query = "SELECT e FROM ServidoresPushJPA e WHERE upper (e.nombre) like :nombre and" +
			" e.tipo = :tipo and (e.eliminado is null or e.eliminado = 'N') order by e.nombre ASC"),
	@NamedQuery(name = "selectServidoresPush_orderbyDescripcion_ASC", query = "SELECT e FROM ServidoresPushJPA e WHERE upper (e.nombre) like :nombre and" +
			" e.tipo = :tipo and (e.eliminado is null or e.eliminado = 'N') order by e.descripcion ASC"),
	@NamedQuery(name = "selectServidoresPush_count", query = "SELECT count(e) FROM ServidoresPushJPA e WHERE upper (e.nombre) like :nombre and" +
			" e.tipo = :tipo and (e.eliminado is null or e.eliminado = 'N')"),
	@NamedQuery(name = "selectServidoresPushByName_count", query = "SELECT count(e) FROM ServidoresPushJPA e WHERE upper (e.nombre) like :nombre and" +
			" e.tipo = :tipo")

})
public class ServidoresPushJPA extends AbstractBaseJPAEntity implements Serializable {
