...
@NamedQueries({         
	@NamedQuery(name = "selectDestinatariosMensajeHistoricosJPA", query = "SELECT e FROM DestinatariosMensajesJPA e where to_char(e.mensajeId)=:mensajeId"),
	@NamedQuery(name = "selectCountDestinatariosMensajeHistoricosJPA", query = "SELECT count(e) FROM DestinatariosMensajesJPA e where to_char(e.mensajeId)=:mensajeId")})

public class DestinatariosMensajesHistoricosJPA extends AbstractBaseJPAEntity implements Serializable {
	...
	public DestinatariosMensajesHistoricosJPA() {
