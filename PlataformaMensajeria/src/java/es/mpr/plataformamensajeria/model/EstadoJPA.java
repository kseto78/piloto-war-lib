...
@NamedQueries({         
	@NamedQuery(name = "selectEstadosJPA", query = "SELECT e FROM EstadoJPA e where e.activo=1")})

public class EstadoJPA extends AbstractBaseJPAEntity implements Serializable {
