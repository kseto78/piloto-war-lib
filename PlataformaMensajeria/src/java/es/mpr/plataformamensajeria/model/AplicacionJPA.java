...
@NamedQueries({
	@NamedQuery(name = "selectAplicacionByName_orderbyNombre_ASC", query = "SELECT e FROM AplicacionJPA e WHERE upper (e.nombre) like upper(concat(concat('%',:nombre),'%'))" +
			" and (e.eliminado is null or e.eliminado = 'N') order by e.nombre ASC"),
@NamedQuery(name = "selectAplicacionByName_orderbyNombre_DESC", query = "SELECT e FROM AplicacionJPA e WHERE upper (e.nombre) like upper(concat(concat('%',:nombre),'%'))" +
		" and (e.eliminado is null or e.eliminado = 'N') order by e.nombre DESC"),
@NamedQuery(name = "selectAplicacion_count", query = "SELECT count(e) FROM AplicacionJPA e WHERE upper (e.nombre) like upper(concat(concat('%',:nombre),'%'))" +
		" and (e.eliminado is null or e.eliminado = 'N')"),
@NamedQuery(name="selectAplicacionJPA",
query="SELECT e FROM AplicacionJPA e WHERE (e.eliminado is null or e.eliminado = 'N') order by e.nombre ASC")})

public class AplicacionJPA extends AbstractBaseJPAEntity implements Serializable {
