...
@XmlSeeAlso({es.redsara.misim.misim_bus_webapp.consultarestado.peticion.ObjectFactory.class, es.redsara.misim.misim_bus_webapp.consultarestado.respuesta.ObjectFactory.class})
...
public interface EnviarMensajesWSBindingPortType {
    ...
    public es.redsara.misim.misim_bus_webapp.consultarestado.respuesta.Respuesta enviarMensaje(
        @WebParam(partName = "peticion", name = "Peticion", targetNamespace = "http://misim.redsara.es/misim-bus-webapp/peticion")
        es.redsara.misim.misim_bus_webapp.consultarestado.peticion.PeticionMisim peticion
    );
}
