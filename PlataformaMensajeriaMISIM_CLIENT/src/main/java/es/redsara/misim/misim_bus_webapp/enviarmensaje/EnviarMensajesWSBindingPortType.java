...
@XmlSeeAlso({es.redsara.misim.misim_bus_webapp.enviarmensaje.peticion.ObjectFactory.class, es.redsara.misim.misim_bus_webapp.enviarmensaje.respuesta.ObjectFactory.class})
...
public interface EnviarMensajesWSBindingPortType {
    ...
    public es.redsara.misim.misim_bus_webapp.enviarmensaje.respuesta.Respuesta enviarMensaje(
        @WebParam(partName = "peticion", name = "Peticion", targetNamespace = "http://misim.redsara.es/misim-bus-webapp/peticion")
        es.redsara.misim.misim_bus_webapp.enviarmensaje.peticion.Peticion peticion
    );
}
