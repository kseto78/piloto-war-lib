...
////CODIGOS GET AVISOS USUARIO////
	public static final String COD_ERROR_DISPOSITIVO = "3013";
	public static final String DETAILS_ERROR_DISPOSITIVO = "No se ha encontrado el identificador de dispositivo.";
	public static final String COD_ERROR_PETICION_GET_AVISOS = "0020";
	public static final String DETAILS_ERROR_PETICION_GET_AVISOS = "La peticion no esta construida correctamente: ";
	
////CODIGOS GET AVISOS USUARIO////
	
////CODIGOS GESTION NOTIFICACIONES PUSH////
	public static String STATUSCODE_KO = "3001";
	public static String STATUSLOGINCODE_KO = "3002";
	public static String STATUSUSERCODE_KO = "3005";
	public static String STATUSDETAILS_KO = "Error en la peticion";
	public static String STATUSLOGIN_KO = "El Usuario y Password no corresponden a ninguna aplicacion";
	public static String STATUS_DETAILS_MESSAGE_KO = "El mensaje no se encuentra en estado ENVIADO o RECIBIDO por tanto no se puede procesar la peticion";
	public static String STATUS_DETAILS_PUSH_MESSAGE_KO = "El identificador de la notificacion no pertenece a una notificacion PUSH";
	public static String STATUSDETAILS_CHANGE_MESSAGE_STATUS_OK = "El estado de la notificacion se ha cambiado satisfactoriamente";
	public static String STATUSDETAILS_USER_OK = "El usuario indicado no se corresponde con el identificador de la notificacion";
	public static String COD_PETICION_INCORRECTA = "0020";
	public static String DETAILS_PETICION_INCORRECTA = "La peticion no esta construida correctamente. Faltan campos obligatorios: status";
	public static String DETAILS_ERROR_USUARIO_PUSH = "El usuario Push no esta registrado";
	public static String DETAILS_MODIFICACION_TODOS_MENSAJES = "Modificado el estado de todos los mensajes satisfactoriamente";
	public static String DETAILS_ERROR_MODIFICACION_TODOS_MENSAJES = "Modificado el estado de todos los mensajes satisfactoriamente";
