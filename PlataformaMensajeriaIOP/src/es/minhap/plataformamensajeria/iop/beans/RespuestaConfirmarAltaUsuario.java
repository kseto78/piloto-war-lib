...
public class RespuestaConfirmarAltaUsuario {
     ...
     *     
     */
    public ResponseStatusTypeConfirmarAltaUsuario getStatus() {
        return status;
    }
     ...
     *     
     */
    public void setStatus(ResponseStatusTypeConfirmarAltaUsuario value) {
        this.status = value;
    }

    
	public String toXML(RespuestaConfirmarAltaUsuario resp) throws PlataformaBusinessException {
		RespuestaConfirmarAltaUsuario respuesta = this;
	...
	public void loadObjectFromXML(String xmlPeticion) throws PlataformaBusinessException {
		...
		try {
			jaxbContext = JAXBContext.newInstance(RespuestaConfirmarAltaUsuario.class);

			Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();

			StringReader reader = new StringReader(xmlPeticion);
			RespuestaConfirmarAltaUsuario peticion = (RespuestaConfirmarAltaUsuario) unmarshaller.unmarshal(reader);
