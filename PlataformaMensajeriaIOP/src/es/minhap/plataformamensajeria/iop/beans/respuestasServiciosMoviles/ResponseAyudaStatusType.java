...
public class ResponseAyudaStatusType {

    @XmlElement(name = "StatusCode", required = true, namespace="http://misim.redsara.es/misim-bus-webapp/respuestaGestionAyuda")
    protected String statusCode;
    @XmlElement(name = "StatusText", required = true, namespace="http://misim.redsara.es/misim-bus-webapp/respuestaGestionAyuda")
    protected String statusText;
    @XmlElement(name = "Details", namespace="http://misim.redsara.es/misim-bus-webapp/respuestaGestionAyuda")
