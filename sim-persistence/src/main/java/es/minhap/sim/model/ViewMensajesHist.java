...
/**
 * ViewMensajesHist generated by hbm2java
 */
@Entity
@Table(name = "VIEW_MENSAJES_HIST")
public class ViewMensajesHist implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8557381299845392350L;
	private ViewMensajesHistId id;

	public ViewMensajesHist() {
	}
