...
/**
 * ViewAdjuntosHist generated by hbm2java
 */
@Entity
@Table(name = "VIEW_ADJUNTOS_HIST")
public class ViewAdjuntosHist implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3272214385086614748L;
	private ViewAdjuntosHistId id;

	public ViewAdjuntosHist() {
	}
