...
/**
 * ViewMensajesDetHist generated by hbm2java
 */
@Entity
@Table(name = "VIEW_MENSAJES_DET_HIST")
public class ViewMensajesDetHist implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5003310794000109540L;
	private ViewMensajesDetHistId id;

	public ViewMensajesDetHist() {
	}
