...
public class TblCanales implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3810229984538386238L;
	@Id
	@Column(name = "CANALID", unique = true, nullable = false, precision = 22, scale = 0)
