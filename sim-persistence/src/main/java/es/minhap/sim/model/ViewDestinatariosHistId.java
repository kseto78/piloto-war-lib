...
/**
 * ViewDestinatariosHistId generated by hbm2java
 */
@Embeddable
public class ViewDestinatariosHistId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7715303264023442134L;

	@Column(name = "DESTINATARIOID", nullable = false, precision = 22, scale = 0)
	private BigDecimal destinatarioid;
	...
	public ViewDestinatariosHistId() {
	}

	@Column(name = "FECHAHISTORIFICACION", length = 7)
	public Date getFechahistorificacion() {
		return this.fechahistorificacion;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewDestinatariosHistId))
			return false;
		ViewDestinatariosHistId castOther = (ViewDestinatariosHistId) other;
	 ...
	 */
	public BigDecimal getDestinatarioid() {
	 ...
	 */
	public void setDestinatarioid(BigDecimal destinatarioid) {
