...
/**
 * ViewGestionEnviosDetHistId generated by hbm2java
 */
@Embeddable
public class ViewGestionEnviosDetHistId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 655781288240488303L;
	...
	public ViewGestionEnviosDetHistId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewGestionEnviosDetHistId))
			return false;
		ViewGestionEnviosDetHistId castOther = (ViewGestionEnviosDetHistId) other;
