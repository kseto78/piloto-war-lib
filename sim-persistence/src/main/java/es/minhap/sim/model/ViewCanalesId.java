...
/**
 * ViewCanalesId generated by hbm2java
 */
@Embeddable
public class ViewCanalesId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6222337149250719312L;

	@Column(name = "CANALID", nullable = false, precision = 22, scale = 0)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewCanalesId))
			return false;
		ViewCanalesId castOther = (ViewCanalesId) other;

		return ((this.getCanalid() == castOther.getCanalid()) || (this
