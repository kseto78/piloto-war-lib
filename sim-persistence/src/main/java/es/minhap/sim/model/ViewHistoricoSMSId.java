...
/**
 * ViewHistoricoSMSId generated by hbm2java
 */
@Embeddable
public class ViewHistoricoSMSId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3678549398520380328L;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewHistoricoSMSId))
			return false;
		ViewHistoricoSMSId castOther = (ViewHistoricoSMSId) other;
