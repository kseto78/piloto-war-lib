/*
 *
 * archivo: ViewEstadoPorEnvioQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewEstadoPorEnvio
 */
public class ViewEstadoPorEnvioQuery extends AbstractHibernateQueryEntity<ViewEstadoPorEnvio> {
     ...
     * Constructor default
     */
    public ViewEstadoPorEnvioQuery() {
     ...
     */
    public ViewEstadoPorEnvioQuery(ViewEstadoPorEnvioId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewEstadoPorEnvioId.
     */
