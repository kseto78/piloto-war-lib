/*
 *
 * archivo: ViewGestionSMSQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewGestionSMS
 */
public class ViewGestionSMSQuery extends AbstractHibernateQueryEntity<ViewGestionSMS> {
     ...
     */
    private ViewGestionSMSId id;

    /**
     * Constructor default
     */
    public ViewGestionSMSQuery() {
     ...
     */
    public ViewGestionSMSQuery(ViewGestionSMSId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewGestionSMSId.
     */
    public ViewGestionSMSId getId() {
        return id;
    }
     ...
     */
    public void setId(ViewGestionSMSId id) {
        this.id = id;
    }
