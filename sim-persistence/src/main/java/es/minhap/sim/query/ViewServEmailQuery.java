/*
 *
 * archivo: ViewServEmailQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewServEmail
 */
public class ViewServEmailQuery extends AbstractHibernateQueryEntity<ViewServEmail> {
     ...
     */
    public ViewServEmailQuery(ViewServEmailId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewServEmailId.
     */
