/*
 *
 * archivo: ViewEnviosPendientesPorCanalQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewEnviosPendientesPorCanal
 */
public class ViewEnviosPendientesPorCanalQuery extends AbstractHibernateQueryEntity<ViewEnviosPendientesPorCanal> {
     ...
     * Constructor default
     */
    public ViewEnviosPendientesPorCanalQuery() {
     ...
     */
    public ViewEnviosPendientesPorCanalQuery(ViewEnviosPendientesPorCanalId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewEnviosPendientesPorCanalId.
     */
