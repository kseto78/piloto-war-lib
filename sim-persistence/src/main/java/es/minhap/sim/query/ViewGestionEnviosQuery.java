/*
 *
 * archivo: ViewGestionEnviosQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewGestionEnvios
 */
public class ViewGestionEnviosQuery extends AbstractHibernateQueryEntity<ViewGestionEnvios> {
     ...
     */
    public ViewGestionEnviosQuery(ViewGestionEnviosId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewGestionEnviosId.
     */
