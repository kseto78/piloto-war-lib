/*
 *
 * archivo: ViewEstadoPorEnvioHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewEstadoPorEnvioHist
 */
public class ViewEstadoPorEnvioHistQuery extends AbstractHibernateQueryEntity<ViewEstadoPorEnvioHist> {
     ...
     * Constructor default
     */
    public ViewEstadoPorEnvioHistQuery() {
     ...
     */
    public ViewEstadoPorEnvioHistQuery(ViewEstadoPorEnvioHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewEstadoPorEnvioHistId.
     */
