/*
 *
 * archivo: ViewProcesosManualesQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewProcesosManuales
 */
public class ViewProcesosManualesQuery extends AbstractHibernateQueryEntity<ViewProcesosManuales> {
    ...
    /**
     * Valor de busqueda de campo job
     */
    private String job;

    /**
     * Tipo de comparador para la busqueda por campo job
     */
    private TextComparator jobComparator = TextComparator.CONTAINS;

    /**
     * Lista de valores del campo job para busquedas tipo IN
     */
    private List<String> jobIn = new ArrayList<String>(0);

    /**
     * Permite buscar cuando campo job es NULL
     */
    private boolean jobIsNull = false;

    /**
     * Permite buscar cuando campo job es NOT NULL
     */
    private boolean jobIsNotNull = false;
     ...
     * Constructor default
     */
    public ViewProcesosManualesQuery() {
     ...
     */
    public ViewProcesosManualesQuery(Long procesosManualesId) {
     ...
     */
    public TextComparator getJobComparator() {
        return jobComparator;
    }

    /**
     * Tipo de comparador para la busqueda por campo job
     * @param jobComparator Valor de seteo.
     */
    public void setJobComparator(TextComparator jobComparator) {
     ...
     * @return List<String>.
     */
    public List<String> getJobIn() {
        return this.jobIn;
    }

    /**
     * @param job Valor a agregar.
     */
    public void addJobIn(String job) {
        this.jobIn.add(job);
    }
     ...
     * @return boolean.
     */
    public boolean isJobIsNull() {
        return jobIsNull;
    }

    /**
     * Permite buscar cuando campo job es NULL
     * @param jobIsNull Valor de seteo.
     */
    public void setJobIsNull(boolean jobIsNull) {
        this.jobIsNull = jobIsNull;
    }
     ...
     * @return boolean.
     */
    public boolean isJobIsNotNull() {
        return jobIsNotNull;
    }

    /**
     * Permite buscar cuando campo job es NOT NULL
     * @param jobIsNotNull Valor de seteo.
     */
    public void setJobIsNotNull(boolean jobIsNotNull) {
        this.jobIsNotNull = jobIsNotNull;
    }
    ...
    public void addCriteria(Criteria criteria, boolean useOrder) {
        ...
        if (getJob() != null) {
            if (getJobComparator() == TextComparator.EQUALS) {
                criteria.add(Restrictions.eq(JOB, getJob()));
            } 
            else if (getJobComparator() == TextComparator.ILIKE) {
                criteria.add(Restrictions.ilike(JOB, getJob()));
            }
            else if (getJobComparator() == TextComparator.UPPERCASE_TRANSLATE) {
                criteria.add(Restrictions.sqlRestriction(createUpperTranslateSQL(JOB, getJob())));
            }
            else {
                criteria.add(Restrictions.like(JOB, getJob()));
            }
        }

        if (getJobIn().size() > 0) {
            criteria.add(Restrictions.in(JOB, getJobIn()));
        }

        if (isJobIsNull()) {
            criteria.add(Restrictions.isNull(JOB));
        }
