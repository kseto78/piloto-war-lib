/*
 *
 * archivo: ViewAdjuntosQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewAdjuntos
 */
public class ViewAdjuntosQuery extends AbstractHibernateQueryEntity<ViewAdjuntos> {
     ...
     */
    public ViewAdjuntosQuery(ViewAdjuntosId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewAdjuntosId.
     */
