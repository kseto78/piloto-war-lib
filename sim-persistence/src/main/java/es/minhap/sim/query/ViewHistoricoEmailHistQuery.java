/*
 *
 * archivo: ViewHistoricoEmailHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewHistoricoEmailHist
 */
public class ViewHistoricoEmailHistQuery extends AbstractHibernateQueryEntity<ViewHistoricoEmailHist> {
     ...
     * Constructor default
     */
    public ViewHistoricoEmailHistQuery() {
     ...
     */
    public ViewHistoricoEmailHistQuery(ViewHistoricoEmailHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewHistoricoEmailHistId.
     */
