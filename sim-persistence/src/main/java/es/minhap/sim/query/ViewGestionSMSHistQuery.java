/*
 *
 * archivo: ViewGestionSMSHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewGestionSMSHist
 */
public class ViewGestionSMSHistQuery extends AbstractHibernateQueryEntity<ViewGestionSMSHist> {
     ...
     * Constructor default
     */
    public ViewGestionSMSHistQuery() {
     ...
     */
    public ViewGestionSMSHistQuery(ViewGestionSMSHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewGestionSMSHistId.
     */
