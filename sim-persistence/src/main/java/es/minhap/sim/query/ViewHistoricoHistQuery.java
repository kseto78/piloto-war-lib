...
public class ViewHistoricoHistQuery extends AbstractHibernateQueryEntity<ViewHistoricoHist> {
     ...
     */
    private ViewHistoricoHistId id;
     ...
     */
    public ViewHistoricoHistQuery(ViewHistoricoHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewHistoricoHistId.
     */
    public ViewHistoricoHistId getId() {
        return id;
    }
     ...
     */
    public void setId(ViewHistoricoHistId id) {
        this.id = id;
    }
