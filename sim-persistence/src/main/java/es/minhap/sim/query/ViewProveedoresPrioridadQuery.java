/*
 *
 * archivo: ViewProveedoresPrioridadQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewProveedoresPrioridad
 */
public class ViewProveedoresPrioridadQuery extends AbstractHibernateQueryEntity<ViewProveedoresPrioridad> {
     ...
     * Constructor default
     */
    public ViewProveedoresPrioridadQuery() {
     ...
     */
    public ViewProveedoresPrioridadQuery(ViewProveedoresPrioridadId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewProveedoresPrioridadId.
     */
