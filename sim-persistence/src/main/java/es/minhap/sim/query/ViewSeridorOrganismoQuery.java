/*
 *
 * archivo: ViewSeridorOrganismoQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewSeridorOrganismo
 */
public class ViewSeridorOrganismoQuery extends AbstractHibernateQueryEntity<ViewSeridorOrganismo> {
     ...
     * Constructor default
     */
    public ViewSeridorOrganismoQuery() {
     ...
     */
    public ViewSeridorOrganismoQuery(ViewSeridorOrganismoId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewSeridorOrganismoId.
     */
