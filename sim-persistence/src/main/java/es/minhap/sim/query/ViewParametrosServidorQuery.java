/*
 *
 * archivo: ViewParametrosServidorQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewParametrosServidor
 */
public class ViewParametrosServidorQuery extends AbstractHibernateQueryEntity<ViewParametrosServidor> {
     ...
     * Constructor default
     */
    public ViewParametrosServidorQuery() {
     ...
     */
    public ViewParametrosServidorQuery(ViewParametrosServidorId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewParametrosServidorId.
     */
