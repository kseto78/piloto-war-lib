/*
 *
 * archivo: ViewEstadoLotesEnviosQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewEstadoLotesEnvios
 */
public class ViewEstadoLotesEnviosQuery extends AbstractHibernateQueryEntity<ViewEstadoLotesEnvios> {
     ...
     * Constructor default
     */
    public ViewEstadoLotesEnviosQuery() {
     ...
     */
    public ViewEstadoLotesEnviosQuery(ViewEstadoLotesEnviosId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewEstadoLotesEnviosId.
     */
