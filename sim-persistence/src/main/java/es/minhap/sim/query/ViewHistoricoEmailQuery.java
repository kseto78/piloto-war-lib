/*
 *
 * archivo: ViewHistoricoEmailQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewHistoricoEmail
 */
public class ViewHistoricoEmailQuery extends AbstractHibernateQueryEntity<ViewHistoricoEmail> {
     ...
     */
    private ViewHistoricoEmailId id;

    /**
     * Constructor default
     */
    public ViewHistoricoEmailQuery() {
     ...
     */
    public ViewHistoricoEmailQuery(ViewHistoricoEmailId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewHistoricoEmailId.
     */
    public ViewHistoricoEmailId getId() {
        return id;
    }
     ...
     */
    public void setId(ViewHistoricoEmailId id) {
        this.id = id;
    }
