/*
 *
 * archivo: ViewMensajesQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewMensajes
 */
public class ViewMensajesQuery extends AbstractHibernateQueryEntity<ViewMensajes> {
     ...
     */
    public ViewMensajesQuery(ViewMensajesId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewMensajesId.
     */
