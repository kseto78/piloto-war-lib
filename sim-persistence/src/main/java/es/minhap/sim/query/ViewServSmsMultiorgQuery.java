/*
 *
 * archivo: ViewServSmsMultiorgQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewServSmsMultiorg
 */
public class ViewServSmsMultiorgQuery extends AbstractHibernateQueryEntity<ViewServSmsMultiorg> {
     ...
     * Constructor default
     */
    public ViewServSmsMultiorgQuery() {
     ...
     */
    public ViewServSmsMultiorgQuery(ViewServSmsMultiorgId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewServSmsMultiorgId.
     */
