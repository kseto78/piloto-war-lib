/*
 *
 * archivo: ViewServServidorPushQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewServServidorPush
 */
public class ViewServServidorPushQuery extends AbstractHibernateQueryEntity<ViewServServidorPush> {
     ...
     * Constructor default
     */
    public ViewServServidorPushQuery() {
     ...
     */
    public ViewServServidorPushQuery(ViewServServidorPushId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewServServidorPushId.
     */
