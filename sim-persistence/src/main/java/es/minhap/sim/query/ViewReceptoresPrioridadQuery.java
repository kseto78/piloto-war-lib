/*
 *
 * archivo: ViewReceptoresPrioridadQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewReceptoresPrioridad
 */
public class ViewReceptoresPrioridadQuery extends AbstractHibernateQueryEntity<ViewReceptoresPrioridad> {
     ...
     * Constructor default
     */
    public ViewReceptoresPrioridadQuery() {
     ...
     */
    public ViewReceptoresPrioridadQuery(ViewReceptoresPrioridadId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewReceptoresPrioridadId.
     */
