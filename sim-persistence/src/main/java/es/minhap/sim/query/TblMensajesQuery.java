...
/**
 * Clase con criterios de busqueda para la entidad TblMensajes
 */
public class TblMensajesQuery extends AbstractHibernateQueryEntity<TblMensajes> {
    ...
    public static final String TBLLOTESENVIOS = "tblLotesEnvios";
    ...
    /**
     * Valor de busqueda de campo tblLotesEnvios
     */
    private TblLotesEnviosQuery tblLotesEnvios;

    /**
     * Lista de valores del ID del campo tblLotesEnvios para busquedas tipo IN
     * Solo se consideran los ID dentro de los TblLotesEnvios
     */
    private List<TblLotesEnvios> tblLotesEnviosIdIn = new ArrayList<TblLotesEnvios>(0);

    /**
     * Permite buscar cuando campo tblLotesEnvios es NULL
     */
    private boolean tblLotesEnviosIsNull = false;

    /**
     * Permite buscar cuando campo tblLotesEnvios es NOT NULL
     */
    private boolean tblLotesEnviosIsNotNull = false;
    ...
    /**
     * Indica si en la consulta se hace un inner join con el padre tblLotesEnvios
     */
    private boolean innerJoinTblLotesEnvios = false;

    /**
     * Indica si en la consulta se hace un left join con el padre tblLotesEnvios
     */
     ...
     */
    public TblMensajesQuery(Long mensajeid) {
    ...
    /**
     * Valor de busqueda de campo tblLotesEnvios
     * @return TblLotesEnvios.
     */
    public TblLotesEnviosQuery getTblLotesEnvios() {
        return tblLotesEnvios;
    }

    /**
     * Valor de busqueda de campo tblLotesEnvios
     * @param tblLotesEnvios Valor de seteo.
     */
    public void setTblLotesEnvios(TblLotesEnviosQuery tblLotesEnvios) {
        this.tblLotesEnvios = tblLotesEnvios;
    }

    /**
     * @return List<TblLotesEnvios>.
     */
    public List<TblLotesEnvios> getTblLotesEnviosIdIn() {
        return this.tblLotesEnviosIdIn;
    }

    /**
     * @param tblLotesEnvios Valor a agregar.
     */
    public void addTblLotesEnviosIdIn(TblLotesEnvios tblLotesEnvios) {
        this.tblLotesEnviosIdIn.add(tblLotesEnvios);
    }
     ...
     * @return boolean.
     */
    public boolean isTblLotesEnviosIsNull() {
        return tblLotesEnviosIsNull;
    }

    /**
     * Permite buscar cuando campo tblLotesEnvios es NULL
     * @param tblLotesEnviosIsNull Valor de seteo.
     */
    public void setTblLotesEnviosIsNull(boolean tblLotesEnviosIsNull) {
        this.tblLotesEnviosIsNull = tblLotesEnviosIsNull;
    }
     ...
     * @return boolean.
     */
    public boolean isTblLotesEnviosIsNotNull() {
        return tblLotesEnviosIsNotNull;
    }

    /**
     * Permite buscar cuando campo tblLotesEnvios es NOT NULL
     * @param tblLotesEnviosIsNotNull Valor de seteo.
     */
    public void setTblLotesEnviosIsNotNull(boolean tblLotesEnviosIsNotNull) {
        this.tblLotesEnviosIsNotNull = tblLotesEnviosIsNotNull;
    }
     ...
     * @return boolean.
     */
    public boolean isInnerJoinTblLotesEnvios() {
        return innerJoinTblLotesEnvios;
    }

    /**
     * @param innerJoinTblLotesEnvios Valor de seteo.
     */
    public void setInnerJoinTblLotesEnvios(boolean innerJoinTblLotesEnvios) {
        this.innerJoinTblLotesEnvios = innerJoinTblLotesEnvios;
    }

    /**
     * @return boolean.
     */
    public boolean isLeftJoinTblLotesEnvios() {
        return leftJoinTblLotesEnvios;
    }

    /**
     * @param leftJoinTblLotesEnvios Valor de seteo.
     */
    public void setLeftJoinTblLotesEnvios(boolean leftJoinTblLotesEnvios) {
        this.leftJoinTblLotesEnvios = leftJoinTblLotesEnvios;
    }
    ...
    public void addCriteria(Criteria criteria, boolean useOrder) {
        ...
        // Campo entidad padre tblLotesEnvios
        
        // Si se hace join fetch con el padre
        Criteria tblLotesEnviosCriteria = null;
        if (isInnerJoinTblLotesEnvios()) {
            tblLotesEnviosCriteria = criteria.createCriteria(TBLLOTESENVIOS, "a_" + TBLLOTESENVIOS, CriteriaSpecification.INNER_JOIN);
        } else if (isLeftJoinTblLotesEnvios()) {
            tblLotesEnviosCriteria = criteria.createCriteria(TBLLOTESENVIOS, "a_" + TBLLOTESENVIOS, CriteriaSpecification.LEFT_JOIN);
        }
        
        if (getTblLotesEnvios() != null) {
            if (getTblLotesEnvios().getLoteenvioid() == null) {
                if (tblLotesEnviosCriteria == null) {
                    tblLotesEnviosCriteria = criteria.createCriteria(TBLLOTESENVIOS, "a_" + TBLLOTESENVIOS);
                }
                getTblLotesEnvios().addCriteria(tblLotesEnviosCriteria, useOrder);
            } else {
                TblLotesEnvios parent = new TblLotesEnvios();
                parent.setLoteenvioid(getTblLotesEnvios().getLoteenvioid());
                criteria.add(Restrictions.eq(TBLLOTESENVIOS, parent));
            }
        }

        if (getTblLotesEnviosIdIn().size() > 0) {
            criteria.add(Restrictions.in(TBLLOTESENVIOS, getTblLotesEnviosIdIn()));
        }

        if (isTblLotesEnviosIsNull()) {
            criteria.add(Restrictions.isNull(TBLLOTESENVIOS));
        }

        if (isTblLotesEnviosIsNotNull()) {
            criteria.add(Restrictions.isNotNull(TBLLOTESENVIOS));
        }
