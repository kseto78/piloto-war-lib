/*
 *
 * archivo: ViewMensajesAdjuntosQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewMensajesAdjuntos
 */
public class ViewMensajesAdjuntosQuery extends AbstractHibernateQueryEntity<ViewMensajesAdjuntos> {
     ...
     * Constructor default
     */
    public ViewMensajesAdjuntosQuery() {
     ...
     */
    public ViewMensajesAdjuntosQuery(ViewMensajesAdjuntosId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewMensajesAdjuntosId.
     */
