...
/**
 * Clase con criterios de busqueda para la entidad ViewServSMS
 */
public class ViewServSMSQuery extends AbstractHibernateQueryEntity<ViewServSMS> {
     ...
     */
    public ViewServSMSQuery(ViewServSMSId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewServSMSId.
     */
