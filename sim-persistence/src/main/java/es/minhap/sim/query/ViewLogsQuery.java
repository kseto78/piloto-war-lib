...
/**
 * Clase con criterios de busqueda para la entidad ViewLogs
 */
public class ViewLogsQuery extends AbstractHibernateQueryEntity<ViewLogs> {
     ...
     */
    public ViewLogsQuery(ViewLogsId id) {
        setId(id);
    }
