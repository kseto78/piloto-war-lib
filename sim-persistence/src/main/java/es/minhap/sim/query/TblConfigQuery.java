...
/**
 * Clase con criterios de busqueda para la entidad TblConfig
 */
public class TblConfigQuery extends AbstractHibernateQueryEntity<TblConfig> {
     ...
     */
    public TblConfigQuery(TblConfigId id) {
        setId(id);
    }
