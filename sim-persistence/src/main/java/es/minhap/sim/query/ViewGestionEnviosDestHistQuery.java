/*
 *
 * archivo: ViewGestionEnviosDestHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewGestionEnviosDestHist
 */
public class ViewGestionEnviosDestHistQuery extends AbstractHibernateQueryEntity<ViewGestionEnviosDestHist> {
     ...
     * Constructor default
     */
    public ViewGestionEnviosDestHistQuery() {
     ...
     */
    public ViewGestionEnviosDestHistQuery(ViewGestionEnviosDestHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewGestionEnviosDestHistId.
     */
