...
/**
 * Clase con criterios de busqueda para la entidad ViewSMS
 */
public class ViewSMSQuery extends AbstractHibernateQueryEntity<ViewSMS> {
     ...
     */
    public ViewSMSQuery(ViewSMSId id) {
        setId(id);
    }
