/*
 *
 * archivo: ViewInformesServiciosEstadoQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewInformesServiciosEstado
 */
public class ViewInformesServiciosEstadoQuery extends AbstractHibernateQueryEntity<ViewInformesServiciosEstado> {
     ...
     * Constructor default
     */
    public ViewInformesServiciosEstadoQuery() {
     ...
     */
    public ViewInformesServiciosEstadoQuery(ViewInformesServiciosEstadoId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewInformesServiciosEstadoId.
     */
