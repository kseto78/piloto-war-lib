/*
 *
 * archivo: ViewServidoresPrioridadQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewServidoresPrioridad
 */
public class ViewServidoresPrioridadQuery extends AbstractHibernateQueryEntity<ViewServidoresPrioridad> {
     ...
     * Constructor default
     */
    public ViewServidoresPrioridadQuery() {
     ...
     */
    public ViewServidoresPrioridadQuery(ViewServidoresPrioridadId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewServidoresPrioridadId.
     */
