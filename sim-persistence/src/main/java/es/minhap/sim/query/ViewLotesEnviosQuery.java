/*
 *
 * archivo: ViewLotesEnviosQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewLotesEnvios
 */
public class ViewLotesEnviosQuery extends AbstractHibernateQueryEntity<ViewLotesEnvios> {
     ...
     */
    public ViewLotesEnviosQuery(ViewLotesEnviosId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewLotesEnviosId.
     */
