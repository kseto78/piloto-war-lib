/*
 *
 * archivo: ViewLotesEnviosHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewLotesEnviosHist
 */
public class ViewLotesEnviosHistQuery extends AbstractHibernateQueryEntity<ViewLotesEnviosHist> {
     ...
     * Constructor default
     */
    public ViewLotesEnviosHistQuery() {
     ...
     */
    public ViewLotesEnviosHistQuery(ViewLotesEnviosHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewLotesEnviosHistId.
     */
