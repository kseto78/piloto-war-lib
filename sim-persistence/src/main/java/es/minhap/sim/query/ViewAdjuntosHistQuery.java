/*
 *
 * archivo: ViewAdjuntosHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewAdjuntosHist
 */
public class ViewAdjuntosHistQuery extends AbstractHibernateQueryEntity<ViewAdjuntosHist> {
     ...
     */
    private ViewAdjuntosHistId id;

    /**
     * Constructor default
     */
    public ViewAdjuntosHistQuery() {
     ...
     */
    public ViewAdjuntosHistQuery(ViewAdjuntosHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewAdjuntosHistId.
     */
    public ViewAdjuntosHistId getId() {
        return id;
    }
     ...
     */
    public void setId(ViewAdjuntosHistId id) {
        this.id = id;
    }
