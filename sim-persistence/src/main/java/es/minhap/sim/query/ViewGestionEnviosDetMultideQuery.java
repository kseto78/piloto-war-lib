/*
 *
 * archivo: ViewGestionEnviosDetMultideQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewGestionEnviosDetMultide
 */
public class ViewGestionEnviosDetMultideQuery extends AbstractHibernateQueryEntity<ViewGestionEnviosDetMultide> {
     ...
     * Constructor default
     */
    public ViewGestionEnviosDetMultideQuery() {
     ...
     */
    public ViewGestionEnviosDetMultideQuery(ViewGestionEnviosDetMultideId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewGestionEnviosDetMultideId.
     */
