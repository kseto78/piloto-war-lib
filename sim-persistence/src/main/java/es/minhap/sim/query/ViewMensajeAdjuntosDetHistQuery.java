/*
 *
 * archivo: ViewMensajeAdjuntosDetHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewMensajeAdjuntosDetHist
 */
public class ViewMensajeAdjuntosDetHistQuery extends AbstractHibernateQueryEntity<ViewMensajeAdjuntosDetHist> {
     ...
     * Constructor default
     */
    public ViewMensajeAdjuntosDetHistQuery() {
     ...
     */
    public ViewMensajeAdjuntosDetHistQuery(ViewMensajeAdjuntosDetHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewMensajeAdjuntosDetHistId.
     */
