/*
 *
 * archivo: TblProcesoConsQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad TblProcesoCons
 */
public class TblProcesoConsQuery extends AbstractHibernateQueryEntity<TblProcesoCons> {
    ...
    public static final String PROCESOCONSID = "procesoconsid";
    ...
    /**
     * Valor de busqueda de campo procesoconsid
     */
    private Long procesoconsid;

    /**
     * Lista de valores del campo procesoconsid para busquedas tipo IN
     */
    private List<Long> procesoconsidIn = new ArrayList<Long>(0);
     ...
     */
    public TblProcesoConsQuery(Long procesoconsid) {
        setProcesoconsid(procesoconsid);
    }
    ...
    /**
     * Valor de busqueda de campo procesoconsid
     * @param procesoconsid Valor de seteo.
     */
     ...
     * @return List<Long>.
     */
    public List<Long> getProcesoconsidIn() {
        return this.procesoconsidIn;
    }

    /**
     * @param procesoconsid Valor a agregar.
     */
    public void addProcesoconsidIn(Long procesoconsid) {
        this.procesoconsidIn.add(procesoconsid);
    }
    ...
    public void addCriteria(Criteria criteria, boolean useOrder) {
        ...
        if (getProcesoconsid() != null) {
            criteria.add(Restrictions.eq(PROCESOCONSID, getProcesoconsid()));
        }

        if (getProcesoconsidIn().size() > 0) {
            criteria.add(Restrictions.in(PROCESOCONSID, getProcesoconsidIn()));
        }
