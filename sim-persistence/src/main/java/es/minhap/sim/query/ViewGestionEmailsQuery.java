/*
 *
 * archivo: ViewGestionEmailsQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewGestionEmails
 */
public class ViewGestionEmailsQuery extends AbstractHibernateQueryEntity<ViewGestionEmails> {
     ...
     */
    public ViewGestionEmailsQuery(ViewGestionEmailsId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewGestionEmailsId.
     */
