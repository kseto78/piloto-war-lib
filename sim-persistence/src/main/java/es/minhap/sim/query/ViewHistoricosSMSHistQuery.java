/*
 *
 * archivo: ViewHistoricosSMSHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewHistoricosSMSHist
 */
public class ViewHistoricosSMSHistQuery extends AbstractHibernateQueryEntity<ViewHistoricosSMSHist> {
     ...
     * Constructor default
     */
    public ViewHistoricosSMSHistQuery() {
     ...
     */
    public ViewHistoricosSMSHistQuery(ViewHistoricosSMSHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewHistoricosSMSHistId.
     */
