/*
 *
 * archivo: ViewHistoricoQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewHistorico
 */
public class ViewHistoricoQuery extends AbstractHibernateQueryEntity<ViewHistorico> {
     ...
     */
    public ViewHistoricoQuery(Long historicoid) {
