/*
 *
 * archivo: ViewGestionEnviosDetHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewGestionEnviosDetHist
 */
public class ViewGestionEnviosDetHistQuery extends AbstractHibernateQueryEntity<ViewGestionEnviosDetHist> {
     ...
     * Constructor default
     */
    public ViewGestionEnviosDetHistQuery() {
     ...
     */
    public ViewGestionEnviosDetHistQuery(ViewGestionEnviosDetHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewGestionEnviosDetHistId.
     */
