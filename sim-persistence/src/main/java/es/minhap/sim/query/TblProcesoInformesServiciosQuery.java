/*
 *
 * archivo: TblProcesoInformesServiciosQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad TblProcesoInformesServicios
 */
public class TblProcesoInformesServiciosQuery extends AbstractHibernateQueryEntity<TblProcesoInformesServicios> {
    ...
    public static final String PROCESOINFORMESSERVICIOSID = "procesoinformesserviciosid";
    ...
    /**
     * Valor de busqueda de campo procesoinformesserviciosid
     */
    private Long procesoinformesserviciosid;

    /**
     * Lista de valores del campo procesoinformesserviciosid para busquedas tipo IN
     */
    private List<Long> procesoinformesserviciosidIn = new ArrayList<Long>(0);
     ...
     * Constructor default
     */
    public TblProcesoInformesServiciosQuery() {
     ...
     */
    public TblProcesoInformesServiciosQuery(Long procesoinformesserviciosid) {
        setProcesoinformesserviciosid(procesoinformesserviciosid);
    }
    ...
    /**
     * Valor de busqueda de campo procesoinformesserviciosid
     * @param procesoinformesserviciosid Valor de seteo.
     */
     ...
     * @return List<Long>.
     */
    public List<Long> getProcesoinformesserviciosidIn() {
        return this.procesoinformesserviciosidIn;
    }

    /**
     * @param procesoinformesserviciosid Valor a agregar.
     */
    public void addProcesoinformesserviciosidIn(Long procesoinformesserviciosid) {
        this.procesoinformesserviciosidIn.add(procesoinformesserviciosid);
    }
    ...
    public void addCriteria(Criteria criteria, boolean useOrder) {
        ...
        if (getProcesoinformesserviciosid() != null) {
            criteria.add(Restrictions.eq(PROCESOINFORMESSERVICIOSID, getProcesoinformesserviciosid()));
        }

        if (getProcesoinformesserviciosidIn().size() > 0) {
            criteria.add(Restrictions.in(PROCESOINFORMESSERVICIOSID, getProcesoinformesserviciosidIn()));
        }
