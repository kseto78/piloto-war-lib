/*
 *
 * archivo: ViewServReceptorSMSQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewServReceptorSMS
 */
public class ViewServReceptorSMSQuery extends AbstractHibernateQueryEntity<ViewServReceptorSMS> {
     ...
     * Constructor default
     */
    public ViewServReceptorSMSQuery() {
     ...
     */
    public ViewServReceptorSMSQuery(ViewServReceptorSMSId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewServReceptorSMSId.
     */
