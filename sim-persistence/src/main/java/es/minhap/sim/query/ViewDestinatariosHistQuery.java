/*
 *
 * archivo: ViewDestinatariosHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewDestinatariosHist
 */
public class ViewDestinatariosHistQuery extends AbstractHibernateQueryEntity<ViewDestinatariosHist> {
     ...
     * Constructor default
     */
    public ViewDestinatariosHistQuery() {
     ...
     */
    public ViewDestinatariosHistQuery(ViewDestinatariosHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewDestinatariosHistId.
     */
