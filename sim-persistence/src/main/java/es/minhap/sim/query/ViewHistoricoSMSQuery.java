/*
 *
 * archivo: ViewHistoricoSMSQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewHistoricoSMS
 */
public class ViewHistoricoSMSQuery extends AbstractHibernateQueryEntity<ViewHistoricoSMS> {
     ...
     */
    public ViewHistoricoSMSQuery(ViewHistoricoSMSId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewHistoricoSMSId.
     */
