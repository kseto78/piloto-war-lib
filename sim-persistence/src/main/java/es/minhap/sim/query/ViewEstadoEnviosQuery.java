/*
 *
 * archivo: ViewEstadoEnviosQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewEstadoEnvios
 */
public class ViewEstadoEnviosQuery extends AbstractHibernateQueryEntity<ViewEstadoEnvios> {
     ...
     */
    public ViewEstadoEnviosQuery(ViewEstadoEnviosId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewEstadoEnviosId.
     */
