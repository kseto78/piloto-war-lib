/*
 *
 * archivo: ViewGestionEmailsHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewGestionEmailsHist
 */
public class ViewGestionEmailsHistQuery extends AbstractHibernateQueryEntity<ViewGestionEmailsHist> {
     ...
     * Constructor default
     */
    public ViewGestionEmailsHistQuery() {
     ...
     */
    public ViewGestionEmailsHistQuery(ViewGestionEmailsHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewGestionEmailsHistId.
     */
