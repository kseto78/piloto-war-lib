/*
 *
 * archivo: ViewMensajesAdjuntosHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewMensajesAdjuntosHist
 */
public class ViewMensajesAdjuntosHistQuery extends AbstractHibernateQueryEntity<ViewMensajesAdjuntosHist> {
     ...
     * Constructor default
     */
    public ViewMensajesAdjuntosHistQuery() {
     ...
     */
    public ViewMensajesAdjuntosHistQuery(ViewMensajesAdjuntosHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewMensajesAdjuntosHistId.
     */
