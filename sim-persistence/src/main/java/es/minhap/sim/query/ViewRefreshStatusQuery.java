/*
 *
 * archivo: ViewRefreshStatusQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewRefreshStatus
 */
public class ViewRefreshStatusQuery extends AbstractHibernateQueryEntity<ViewRefreshStatus> {
     ...
     */
    public ViewRefreshStatusQuery(ViewRefreshStatusId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewRefreshStatusId.
     */
