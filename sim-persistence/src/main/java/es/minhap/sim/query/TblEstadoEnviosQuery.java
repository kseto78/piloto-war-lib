/*
 *
 * archivo: TblEstadoEnviosQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad TblEstadoEnvios
 */
public class TblEstadoEnviosQuery extends AbstractHibernateQueryEntity<TblEstadoEnvios> {
     ...
     */
    public TblEstadoEnviosQuery(Long estadoenvioid) {
        setEstadoenvioid(estadoenvioid);
    }
