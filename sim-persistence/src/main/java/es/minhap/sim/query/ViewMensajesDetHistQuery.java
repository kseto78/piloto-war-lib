/*
 *
 * archivo: ViewMensajesDetHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewMensajesDetHist
 */
public class ViewMensajesDetHistQuery extends AbstractHibernateQueryEntity<ViewMensajesDetHist> {
     ...
     */
    private ViewMensajesDetHistId id;

    /**
     * Constructor default
     */
    public ViewMensajesDetHistQuery() {
     ...
     */
    public ViewMensajesDetHistQuery(ViewMensajesDetHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewMensajesDetHistId.
     */
    public ViewMensajesDetHistId getId() {
        return id;
    }
     ...
     */
    public void setId(ViewMensajesDetHistId id) {
        this.id = id;
    }
