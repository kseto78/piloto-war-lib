/*
 *
 * archivo: ViewServicioOrganismosQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewServicioOrganismos
 */
public class ViewServicioOrganismosQuery extends AbstractHibernateQueryEntity<ViewServicioOrganismos> {
     ...
     * Constructor default
     */
    public ViewServicioOrganismosQuery() {
     ...
     */
    public ViewServicioOrganismosQuery(ViewServicioOrganismosId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewServicioOrganismosId.
     */
