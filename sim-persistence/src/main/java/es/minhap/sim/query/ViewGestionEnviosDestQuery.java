/*
 *
 * archivo: ViewGestionEnviosDestQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewGestionEnviosDest
 */
public class ViewGestionEnviosDestQuery extends AbstractHibernateQueryEntity<ViewGestionEnviosDest> {
     ...
     */
    private ViewGestionEnviosDestId id;

    /**
     * Constructor default
     */
    public ViewGestionEnviosDestQuery() {
     ...
     */
    public ViewGestionEnviosDestQuery(ViewGestionEnviosDestId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewGestionEnviosDestId.
     */
    public ViewGestionEnviosDestId getId() {
        return id;
    }
     ...
     */
    public void setId(ViewGestionEnviosDestId id) {
        this.id = id;
    }
