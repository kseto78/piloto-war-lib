/*
 *
 * archivo: ViewServidoresPushPrioridadQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewServidoresPushPrioridad
 */
public class ViewServidoresPushPrioridadQuery extends AbstractHibernateQueryEntity<ViewServidoresPushPrioridad> {
     ...
     * Constructor default
     */
    public ViewServidoresPushPrioridadQuery() {
     ...
     */
    public ViewServidoresPushPrioridadQuery(ViewServidoresPushPrioridadId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewServidoresPushPrioridadId.
     */
