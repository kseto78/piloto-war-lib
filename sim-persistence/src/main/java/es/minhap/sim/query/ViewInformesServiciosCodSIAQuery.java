/*
 *
 * archivo: ViewInformesServiciosCodSIAQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewInformesServiciosCodSIA
 */
public class ViewInformesServiciosCodSIAQuery extends AbstractHibernateQueryEntity<ViewInformesServiciosCodSIA> {
     ...
     * Constructor default
     */
    public ViewInformesServiciosCodSIAQuery() {
     ...
     */
    public ViewInformesServiciosCodSIAQuery(ViewInformesServiciosCodSIAId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewInformesServiciosCodSIAId.
     */
