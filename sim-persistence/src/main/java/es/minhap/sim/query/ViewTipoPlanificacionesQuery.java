/*
 *
 * archivo: ViewTipoPlanificacionesQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewTipoPlanificaciones
 */
public class ViewTipoPlanificacionesQuery extends AbstractHibernateQueryEntity<ViewTipoPlanificaciones> {
     ...
     * Constructor default
     */
    public ViewTipoPlanificacionesQuery() {
     ...
     */
    public ViewTipoPlanificacionesQuery(ViewTipoPlanificacionesId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewTipoPlanificacionesId.
     */
