...
/**
 * Clase con criterios de busqueda para la entidad TblCanales
 */
public class TblCanalesQuery extends AbstractHibernateQueryEntity<TblCanales> {
     ...
     */
    public TblCanalesQuery(Long canalid) {
        setCanalid(canalid);
    }
