/*
 *
 * archivo: ViewConsolidacionHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewConsolidacionHist
 */
public class ViewConsolidacionHistQuery extends AbstractHibernateQueryEntity<ViewConsolidacionHist> {
     ...
     * Constructor default
     */
    public ViewConsolidacionHistQuery() {
     ...
     */
    public ViewConsolidacionHistQuery(ViewConsolidacionHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewConsolidacionHistId.
     */
