/*
 *
 * archivo: ViewProvPrioridadMultiorgQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewProvPrioridadMultiorg
 */
public class ViewProvPrioridadMultiorgQuery extends AbstractHibernateQueryEntity<ViewProvPrioridadMultiorg> {
     ...
     * Constructor default
     */
    public ViewProvPrioridadMultiorgQuery() {
     ...
     */
    public ViewProvPrioridadMultiorgQuery(ViewProvPrioridadMultiorgId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewProvPrioridadMultiorgId.
     */
