/*
 *
 * archivo: ViewGestionEnviosHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewGestionEnviosHist
 */
public class ViewGestionEnviosHistQuery extends AbstractHibernateQueryEntity<ViewGestionEnviosHist> {
     ...
     */
    private ViewGestionEnviosHistId id;

    /**
     * Constructor default
     */
    public ViewGestionEnviosHistQuery() {
     ...
     */
    public ViewGestionEnviosHistQuery(ViewGestionEnviosHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewGestionEnviosHistId.
     */
    public ViewGestionEnviosHistId getId() {
        return id;
    }
     ...
     */
    public void setId(ViewGestionEnviosHistId id) {
        this.id = id;
    }
