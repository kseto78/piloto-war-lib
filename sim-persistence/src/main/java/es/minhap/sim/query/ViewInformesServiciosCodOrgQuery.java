/*
 *
 * archivo: ViewInformesServiciosCodOrgQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewInformesServiciosCodOrg
 */
public class ViewInformesServiciosCodOrgQuery extends AbstractHibernateQueryEntity<ViewInformesServiciosCodOrg> {
     ...
     * Constructor default
     */
    public ViewInformesServiciosCodOrgQuery() {
     ...
     */
    public ViewInformesServiciosCodOrgQuery(ViewInformesServiciosCodOrgId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewInformesServiciosCodOrgId.
     */
