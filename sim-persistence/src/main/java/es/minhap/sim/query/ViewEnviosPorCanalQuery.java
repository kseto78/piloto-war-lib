/*
 *
 * archivo: ViewEnviosPorCanalQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewEnviosPorCanal
 */
public class ViewEnviosPorCanalQuery extends AbstractHibernateQueryEntity<ViewEnviosPorCanal> {
     ...
     * Constructor default
     */
    public ViewEnviosPorCanalQuery() {
     ...
     */
    public ViewEnviosPorCanalQuery(ViewEnviosPorCanalId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewEnviosPorCanalId.
     */
