/*
 *
 * archivo: ViewMensajesHistQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewMensajesHist
 */
public class ViewMensajesHistQuery extends AbstractHibernateQueryEntity<ViewMensajesHist> {
     ...
     */
    private ViewMensajesHistId id;

    /**
     * Constructor default
     */
    public ViewMensajesHistQuery() {
     ...
     */
    public ViewMensajesHistQuery(ViewMensajesHistId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewMensajesHistId.
     */
    public ViewMensajesHistId getId() {
        return id;
    }
     ...
     */
    public void setId(ViewMensajesHistId id) {
        this.id = id;
    }
