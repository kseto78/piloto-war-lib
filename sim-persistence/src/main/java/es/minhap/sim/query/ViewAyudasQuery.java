...
/**
 * Clase con criterios de busqueda para la entidad ViewAyudas
 */
public class ViewAyudasQuery extends AbstractHibernateQueryEntity<ViewAyudas> {
     ...
     */
    public ViewAyudasQuery(ViewAyudasId id) {
        setId(id);
    }
