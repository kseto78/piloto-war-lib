...
/**
 * Clase con criterios de busqueda para la entidad ViewEstados
 */
public class ViewEstadosQuery extends AbstractHibernateQueryEntity<ViewEstados> {
     ...
     */
    public ViewEstadosQuery(ViewEstadosId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewEstadosId.
     */
