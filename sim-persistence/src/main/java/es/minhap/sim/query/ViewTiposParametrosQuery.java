/*
 *
 * archivo: ViewTiposParametrosQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewTiposParametros
 */
public class ViewTiposParametrosQuery extends AbstractHibernateQueryEntity<ViewTiposParametros> {
     ...
     * Constructor default
     */
    public ViewTiposParametrosQuery() {
     ...
     */
    public ViewTiposParametrosQuery(ViewTiposParametrosId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewTiposParametrosId.
     */
