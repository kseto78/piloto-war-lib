/*
 *
 * archivo: ViewInformesServiciosCopQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewInformesServiciosCop
 */
public class ViewInformesServiciosCopQuery extends AbstractHibernateQueryEntity<ViewInformesServiciosCop> {
     ...
     * Constructor default
     */
    public ViewInformesServiciosCopQuery() {
     ...
     */
    public ViewInformesServiciosCopQuery(ViewInformesServiciosCopId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewInformesServiciosCopId.
     */
