/*
 *
 * archivo: ViewAplicacionesQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewAplicaciones
 */
public class ViewAplicacionesQuery extends AbstractHibernateQueryEntity<ViewAplicaciones> {
     ...
     */
    public ViewAplicacionesQuery(ViewAplicacionesId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewAplicacionesId.
     */
