/*
 *
 * archivo: ViewServidoresQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewServidores
 */
public class ViewServidoresQuery extends AbstractHibernateQueryEntity<ViewServidores> {
     ...
     */
    public ViewServidoresQuery(ViewServidoresId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewServidoresId.
     */
