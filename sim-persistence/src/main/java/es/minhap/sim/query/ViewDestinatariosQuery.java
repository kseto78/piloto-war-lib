/*
 *
 * archivo: ViewDestinatariosQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewDestinatarios
 */
public class ViewDestinatariosQuery extends AbstractHibernateQueryEntity<ViewDestinatarios> {
     ...
     */
    public ViewDestinatariosQuery(ViewDestinatariosId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewDestinatariosId.
     */
