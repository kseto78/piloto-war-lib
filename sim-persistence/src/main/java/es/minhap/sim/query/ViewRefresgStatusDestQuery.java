/*
 *
 * archivo: ViewRefresgStatusDestQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewRefresgStatusDest
 */
public class ViewRefresgStatusDestQuery extends AbstractHibernateQueryEntity<ViewRefresgStatusDest> {
     ...
     * Constructor default
     */
    public ViewRefresgStatusDestQuery() {
     ...
     */
    public ViewRefresgStatusDestQuery(ViewRefresgStatusDestId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewRefresgStatusDestId.
     */
