/*
 *
 * archivo: TblHistoricosQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad TblHistoricos
 */
public class TblHistoricosQuery extends AbstractHibernateQueryEntity<TblHistoricos> {
     ...
     */
    public TblHistoricosQuery(Long historicoid) {
