/*
 *
 * archivo: ViewEstadisticaQuery.java
 *
...
/**
 * Clase con criterios de busqueda para la entidad ViewEstadistica
 */
public class ViewEstadisticaQuery extends AbstractHibernateQueryEntity<ViewEstadistica> {
     ...
     */
    public ViewEstadisticaQuery(ViewEstadisticaId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewEstadisticaId.
     */
