...
/**
 * Clase con criterios de busqueda para la entidad ViewCanales
 */
public class ViewCanalesQuery extends AbstractHibernateQueryEntity<ViewCanales> {
     ...
     */
    public ViewCanalesQuery(ViewCanalesId id) {
        setId(id);
    }

    /**
     * Valor de busqueda de campo id
     * @return ViewCanalesId.
     */
