...
public class RespuestaSAMLRequest {
    ...
    @XmlElement(name = "Parameters", required = true, namespace = "http://misim.redsara.es/misim-bus-webapp/respuestaSAMLResponse")
	private Parametros parameters;
    @XmlElement(name = "UrlClave", required = true, namespace = "http://misim.redsara.es/misim-bus-webapp/respuestaSAMLResponse")
   	private String urlClave;
    @XmlElement(name = "UrlReturn", required = true, namespace = "http://misim.redsara.es/misim-bus-webapp/respuestaSAMLResponse")
