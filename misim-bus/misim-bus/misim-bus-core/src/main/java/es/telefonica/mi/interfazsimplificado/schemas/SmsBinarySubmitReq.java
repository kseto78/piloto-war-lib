 ...
 *         &lt;element name="Recipients" type="{http://www.telefonica.es/MI/InterfazSimplificado/schemas}recipientsType"/>
 *         &lt;element name="SMSData" type="{http://www.w3.org/2001/XMLSchema}base64Binary" minOccurs="0"/>
 *         &lt;element name="UserDataHeader" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="DataCodingScheme" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "smsBinarySubmitReq")
public class SmsBinarySubmitReq {
    ...
    @XmlElement(name = "SMSData")
    protected byte[] smsData;
    @XmlElement(name = "UserDataHeader")
    protected String userDataHeader;
    @XmlElement(name = "DataCodingScheme", required = true)
    protected String dataCodingScheme;
    ...
    /**
     * Obtiene el valor de la propiedad smsData.
     * 
     * @return
     *     possible object is
     *     byte[]
    ...
    /**
     * Define el valor de la propiedad smsData.
     * 
     * @param value
     *     allowed object is
     *     byte[]
     */
    public void setSMSData(byte[] value) {
        this.smsData = value;
    }

    /**
     * Obtiene el valor de la propiedad userDataHeader.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define el valor de la propiedad userDataHeader.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
    ...
    /**
     * Obtiene el valor de la propiedad dataCodingScheme.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define el valor de la propiedad dataCodingScheme.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setDataCodingScheme(String value) {
