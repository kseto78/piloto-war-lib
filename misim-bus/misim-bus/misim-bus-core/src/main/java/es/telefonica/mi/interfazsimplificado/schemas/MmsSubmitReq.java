 ...
 *         &lt;element name="Contents" type="{http://www.telefonica.es/MI/InterfazSimplificado/schemas}mmsContentsType"/>
...
@XmlRootElement(name = "mmsSubmitReq")
public class MmsSubmitReq {
    ...
    protected MmsContentsType contents;
     ...
     * @return
     *     possible object is
     *     {@link MmsContentsType }
     *     
     */
    public MmsContentsType getContents() {
        return contents;
    }
     ...
     *     
     */
    public void setContents(MmsContentsType value) {
        this.contents = value;
    }
