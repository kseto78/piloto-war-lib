...
public class RespuestaSAMLResponse {
    ...
    @XmlElement(name = "NIF", required = true, namespace = "http://misim.redsara.es/misim-bus-webapp/respuestaSAMLResponse")
	private String nif;
    @XmlElement(name = "Nombre", required = true, namespace = "http://misim.redsara.es/misim-bus-webapp/respuestaSAMLResponse")
	private String nombre;
    @XmlElement(name = "Apellido1", required = true, namespace = "http://misim.redsara.es/misim-bus-webapp/respuestaSAMLResponse")
	private String apellido1;
    @XmlElement(name = "Apellido2", required = true, namespace = "http://misim.redsara.es/misim-bus-webapp/respuestaSAMLResponse")
