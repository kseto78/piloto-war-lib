 ...
 * 2016-06-22T14:40:04.786+02:00
 * Generated source version: 2.7.1
 * 
 */
@WebServiceClient(name = "EnviarMensajesWS", 
                  wsdlLocation = "file:/C:/MISIM/workspace/misim-bus/misim-bus-core/src/main/resources/wsdl/envio-sim/enviarMensajes.wsdl",
...
public class EnviarMensajesWS extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/MISIM/workspace/misim-bus/misim-bus-core/src/main/resources/wsdl/envio-sim/enviarMensajes.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EnviarMensajesWS.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/MISIM/workspace/misim-bus/misim-bus-core/src/main/resources/wsdl/envio-sim/enviarMensajes.wsdl");
        }
        WSDL_LOCATION = url;
    }
