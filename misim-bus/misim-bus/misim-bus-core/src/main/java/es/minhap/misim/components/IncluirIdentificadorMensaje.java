 ...
 * 
 */
public class IncluirIdentificadorMensaje implements Callable {

	private static final Logger LOG = LoggerFactory.getLogger(IncluirIdentificadorMensaje.class);
...
//			System.out.println("Antes de modificar id MENSAJE: " + XMLUtils.dom2xml(docOriginal));
			...
			String idSms=String.class.cast(eventContext.getMessage().getOutboundProperty("idMensaje"));
			String xmlDocumento=XMLUtils.dom2xml(docOriginal);
			xmlDocumento=xmlDocumento.replace("idDelMensaje", idSms);
