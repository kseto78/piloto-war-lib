 ...
 * 
 */
public class ActualizarAuditoriaFault implements Callable {

	private static final Logger LOG = LoggerFactory.getLogger(ActualizarAuditoriaFault.class);
	...
	public Object onCall(final MuleEventContext eventContext) throws Exception {
		...
		LOG.debug("Inicio de actualización de auditoría");
		...
		try{
			...
			if(idAuditoria!=null && !("").equals(idAuditoria)){
			...
			String xmlPeticionOriginal = eventContext.getMessage().getOutboundProperty("xmlFault"); 
		...
		LOG.debug("Fin de actualización de auditoría");
