...
public class InvocarConsultaHistorial implements Callable {
	...
	public Object onCall(final MuleEventContext eventContext) throws ModelException {
		...
		try{
			...
			NodeList peticion = docOriginal.getElementsByTagNameNS("http://misim.redsara.es/misim-bus-webapp/peticion", "PeticionHistorico");
			...
			String respuesta=seguimientoService.consultarHistorial(consultaHistorico);
