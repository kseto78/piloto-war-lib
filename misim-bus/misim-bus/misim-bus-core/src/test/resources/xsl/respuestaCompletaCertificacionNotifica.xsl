...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="pet3:CodigoEstado">
		<xsl:apply-templates select="//ns1:certificacionSedeResponse/return/codigo_respuesta"/>
	</xsl:template>
	
	<xsl:template match="//ns1:certificacionSedeResponse/return/codigo_respuesta">
		<res3:CodigoEstado>
			<xsl:value-of select="." />
		</res3:CodigoEstado>
	</xsl:template>
	...
	<xsl:template match="pet3:LiteralError">
			<xsl:apply-templates select="//ns1:certificacionSedeResponse/return/descripcion_respuesta"/>
	</xsl:template>
	
	<xsl:template match="//ns1:certificacionSedeResponse/return/descripcion_respuesta">
		<res3:LiteralError>
			<xsl:value-of select="." />
		</res3:LiteralError>
	</xsl:template>
	...
	<xsl:template match="pet3:SolicitudTransmision">
		<res3:TransmisionDatos>
			...
			<xsl:call-template name="templateCertificado"/>
<!-- 			<xsl:apply-templates select="//ns1:certificacionSedeResponse/return" /> -->
		</res3:TransmisionDatos>
	</xsl:template>
	...
	<xsl:template name="templateCertificado">
		<dat3:DatosEspecificos xmlns:dat3="http://intermediacion.redsara.es/scsp/esquemas/datosespecificos">
			<ns1:certificacionSedeResponse>
         		<return>
            		<envio_destinatario_id>
						<xsl:value-of select="//ns1:certificacionSedeResponse/return/envio_destinatario_id"/>
					</envio_destinatario_id>
					<codigo_respuesta>
						<xsl:value-of select="//ns1:certificacionSedeResponse/return/codigo_respuesta"/>
					</codigo_respuesta>
					<descripcion_respuesta>
						<xsl:value-of select="//ns1:certificacionSedeResponse/return/descripcion_respuesta"/>
					</descripcion_respuesta>
				</return>
			</ns1:certificacionSedeResponse>
	...
	<xsl:template match="ns1:certificacionSedeResponse/return">
	</xsl:template>
	<!-- Plantilla Datos Especificos -->
