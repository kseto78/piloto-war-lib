	...
	<!-- Plantilla elementos Estado -->	
	 <xsl:template match="pet3:CodigoEstado">
        <xsl:if test="//ns1:recuperarTrazaResponse/ns1:resultTraza/ns2:error != ''">
            <xsl:if test="//ns1:recuperarTrazaResponse/ns1:resultTraza/ns2:error = '0201'">
...
<!-- 	<xsl:template match="ns2:error/ns2:codigo"> -->
<!-- 		<ns2:codigo> -->
<!-- 			<xsl:value-of select="." /> -->
<!-- 		</ns2:codigo> -->
<!-- 	</xsl:template> -->
	
<!-- 	<xsl:template match="ns2:error/ns2:descripcion"> -->
<!-- 		<ns2:descripcion> -->
<!-- 			<xsl:value-of select="." /> -->
<!-- 		</ns2:descripcion> -->
<!-- 	</xsl:template> -->
