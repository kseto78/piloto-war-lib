...
<xsl:stylesheet version="2.0"
    ...
    exclude-result-prefixes="ns1 pet3 xsl">
    ...
    <xsl:template match="pet3:SolicitudTransmision">
        <res3:TransmisionDatos>
            ...
            <xsl:apply-templates select="//ns1:ValidarCertificadoResponse/ValidarCertificadoReturn" />
        </res3:TransmisionDatos>
    </xsl:template>
    ...
    <xsl:template match="ns2:DatosEspecificos">
    </xsl:template>
    
     <xsl:template match="//ns1:ValidarCertificadoResponse/ValidarCertificadoReturn">
        <ns2:DatosEspecificos xmlns:ns2="http://intermediacion.redsara.es/scsp/esquemas/datosespecificos">
           <ValidarCertificadoResponse>
                   <ValidarCertificadoReturn><xsl:value-of select="." /></ValidarCertificadoReturn>
           </ValidarCertificadoResponse>
          </ns2:DatosEspecificos>
    </xsl:template>
    
     <xsl:template match="ns1:ValidarCertificadoResponse">
    </xsl:template>
