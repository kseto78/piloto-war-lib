...
@Component
public class HiloEnviarMensajesExclusivo extends Thread {

	private static final Logger LOG = LoggerFactory.getLogger(HiloEnviarMensajesExclusivo.class);
	...
	public HiloEnviarMensajesExclusivo() {

	}

	public HiloEnviarMensajesExclusivo(ISendMessageService sendMessageService, TblMensajesManager tblMensajesManager,
...
//	@Transactional()
	public void run() {
		...
		try{
			...
			LOG.error(errorClave + "Excepcion en el Thread enviando Mensaje PREMIUM: " + mensajeId, e);
