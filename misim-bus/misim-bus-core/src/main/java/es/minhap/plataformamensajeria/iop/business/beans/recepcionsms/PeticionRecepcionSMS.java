...
public class PeticionRecepcionSMS {
     ...
     *     
     */
    public DatosEspecificosRecepcionSMS getDatosEspecificos() {
     ...
     * @param value
     *     allowed object is
     *     {@link DatosEspecificosRecepcionSMS }
     *     
     */
    public void setDatosEspecificos(DatosEspecificosRecepcionSMS value) {
	...
	public String toXML() {
		...
		PeticionRecepcionSMS pet = this;

		try {
			JAXBContext jaxbContext = JAXBContext.newInstance(PeticionRecepcionSMS.class);
