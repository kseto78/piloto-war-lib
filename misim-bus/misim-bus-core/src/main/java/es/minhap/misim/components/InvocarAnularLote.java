 ...
 * 
 */
public class InvocarAnularLote implements Callable {
	
	private static final Logger LOG = LoggerFactory.getLogger(InvocarAnularLote.class);
	...
	public Object onCall(final MuleEventContext eventContext) throws ModelException {
		...
		try{
			...
			String respuesta=operacionesService.anularLote(operacionesMensajes);
