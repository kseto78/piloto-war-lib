 ...
 * 
 */
public class InvocarAnularMensaje implements Callable {
	
	private static final Logger LOG = LoggerFactory.getLogger(InvocarAnularMensaje.class);
	...
	public Object onCall(final MuleEventContext eventContext) throws ModelException {
		...
		try{
			...
			String respuesta=operacionesService.anularMensaje(operacionesMensajes);
