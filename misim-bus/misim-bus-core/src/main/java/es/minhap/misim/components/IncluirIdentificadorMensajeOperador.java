 ...
 * 
 */
public class IncluirIdentificadorMensajeOperador implements Callable {

	private static final Logger LOG = LoggerFactory.getLogger(IncluirIdentificadorMensajeOperador.class);
