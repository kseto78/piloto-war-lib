 ...
 * 
 */
public class InvocarReenviarMensaje implements Callable {
	
	private static final Logger LOG = LoggerFactory.getLogger(InvocarReenviarMensaje.class);
	...
	public Object onCall(final MuleEventContext eventContext) throws ModelException {
		...
		try{
			...
			NodeList peticion = docOriginal.getElementsByTagNameNS("http://misim.redsara.es/misim-bus-webapp/peticion", "PeticionMensaje");
			...
			String respuesta=operacionesService.reenviarMensaje(operacionesMensajes);
