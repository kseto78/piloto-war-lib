	...
	public Object onCall(final MuleEventContext eventContext) throws ModelException {
		...
		try {
			...
			NodeList peticion = docOriginal.getElementsByTagNameNS(
					"http://misim.redsara.es/misim-bus-webapp/peticionConsultaServiciosDisponibles",
					"PeticionConsultaServiciosDisponibles");
			...
			String respuesta = gestionServiciosPushImpl.consultaServiciosDisponibles(serviciosDispXML);
