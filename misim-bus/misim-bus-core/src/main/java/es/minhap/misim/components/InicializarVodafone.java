...
public class InicializarVodafone implements Callable {
	
	private static final Logger LOG = LoggerFactory.getLogger(InicializarVodafone.class);
	
	private static final String PRODUCTO_RECIBIR = "RECIBIR_SMS";
	private static final String PRODUCTO_NOTIFICAR = "NOTIFICAR_SMS";
	private static final String PROVEEDOR = "VODAFONE";
	private static final String APLICACION = "VODAFONE";
		...
		try {
			...
			if(listaProveedores==null || listaProveedores.isEmpty()){
				...
				NodeList nodeMensaje = docOriginal.getElementsByTagNameNS(
						"http://princast.es/redboxentrada/2.0/redboxentrada.xsd",
						"idContexto");
				...
				if (nodeMensaje.item(0)!=null){
					...
					NodeList nodeMensaje2 = docOriginal.getElementsByTagName("idContexto");
					
					if(nodeMensaje2!=null){
			...
			LOG.error("Identificación: Error de sistema al inicializar Vodafone", e);
			throw new ModelException("Error de sistema al inicializar Vodafone", 502);
		}
