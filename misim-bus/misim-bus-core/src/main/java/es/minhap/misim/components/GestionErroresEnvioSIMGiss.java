 ...
 * 
 */
public class GestionErroresEnvioSIMGiss implements Callable {

	private static final Logger LOG = LoggerFactory.getLogger(GestionErroresEnvioSIMGiss.class);

	@Override
	public Object onCall(final MuleEventContext eventContext) throws Exception {

		LOG.debug("Inicio del proceso de gestión de errores " + getClass());
		...
		LOG.debug("Fin del proceso de gestión de errores " + getClass());
