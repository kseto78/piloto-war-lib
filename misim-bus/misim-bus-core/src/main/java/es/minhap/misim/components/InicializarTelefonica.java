...
public class InicializarTelefonica implements Callable {
	...
	private static final String PROVEEDOR = "TELEFONICA";
	private static final String APLICACION = "TELEFONICA";
		...
		try {
			...
			if(listaProveedores==null || listaProveedores.isEmpty()){
				...
				NodeList nodeMensaje = docOriginal.getElementsByTagNameNS(
						"http://www.telefonica.es/MI/InterfazSimplificado/schemas",
						"MessageId");
				...
				if (nodeMensaje.item(0)!=null){
					...
					NodeList nodeMensaje2 = docOriginal.getElementsByTagName("MessageId");
