 ...
 * 
 */
public class InvocarEnvioWebPush implements Callable {

	private static final Logger LOG = LoggerFactory.getLogger(InvocarEnvioWebPush.class);
	...
	public Object onCall(final MuleEventContext eventContext) throws ModelException {
		...
		try {
			...
			String respuesta = envioLotesMensajesImpl.enviarLotesWebPush(peticionXML);
