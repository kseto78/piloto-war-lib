...
/**
 * base for DR response messages from VASP to R/S
 * 
 * <p>Clase Java para DeliveryReportRes complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="DeliveryReportRes">
 *   &lt;complexContent>
...
@XmlType(name = "DeliveryReportRes", propOrder = {
    "version",
    "status"
})
@XmlRootElement(name="deliveryReportRes", namespace="http://www.telefonica.es/MI/InterfazSimplificado/schemas")
