...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="pet3:CodigoEstado">
        <xsl:apply-templates select="//ns1:revocarApoderamientoResponse/ns1:return/error/codError"/> 
    </xsl:template>

    <xsl:template match="//ns1:revocarApoderamientoResponse/ns1:return/error/codError">
        <res3:CodigoEstado>
            <xsl:choose>
    ...
    <xsl:template match="pet3:LiteralError">
        <xsl:apply-templates select="//ns1:revocarApoderamientoResponse/ns1:return/error/desError"/>
    </xsl:template>
    
    <xsl:template match="//ns1:revocarApoderamientoResponse/ns1:return/error/desError">
        <res3:LiteralError>
            <xsl:value-of select="." />
        </res3:LiteralError>
    </xsl:template>
    ...
    <xsl:template match="pet3:SolicitudTransmision">
        <res3:TransmisionDatos>
            ...
            <xsl:apply-templates select="//ns1:revocarApoderamientoResponse/Salida" />
        </res3:TransmisionDatos>
    </xsl:template>
    ...
    <xsl:template match="//ns1:revocarApoderamientoResponse/ns1:return/valido">
        <dat3:DatosEspecificos xmlns:dat3="http://intermediacion.redsara.es/scsp/esquemas/datosespecificos">
            <revocarApoderamientoResponse>
                <Salida>
                    <Valido>
                        <xsl:apply-templates />
                    </Valido>
    ...
    <xsl:template match="ns1:revocarApoderamientoResponse/ns1:return/valido/numRegistro">
        <NumRegistro>
            <xsl:apply-templates />
        </NumRegistro>
    </xsl:template>
    
    <xsl:template match="ns1:revocarApoderamientoResponse/ns1:return/valido/documentoJustificante">
        <DocumentoJustificante>
            <xsl:apply-templates />
        </DocumentoJustificante>
    </xsl:template>
    
    <xsl:template match="ns1:revocarApoderamientoResponse/ns1:return/valido/codOrganismo">
        <codOrganismo>
            <xsl:apply-templates />
        </codOrganismo>
    </xsl:template>
    
    <xsl:template match="ns1:revocarApoderamientoResponse/ns1:return/valido/estado">
        <estado>
            <xsl:apply-templates />
        </estado>
    </xsl:template>
    
    <xsl:template match="ns1:revocarApoderamientoResponse/ns1:return/valido/codApoderamiento">
        <codApoderamiento>
            <xsl:apply-templates />
        </codApoderamiento>
    </xsl:template>
    
    <xsl:template match="ns1:revocarApoderamientoResponse/ns1:return/error">
    </xsl:template>
   
    <xsl:template match="ns1:revocarApoderamientoResponse">
    </xsl:template>
