...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="pet3:SolicitudTransmision">
        <res3:TransmisionDatos>
            ...
            <xsl:apply-templates select="//ns1:ValidarFirmaResponse/ValidarFirmaReturn" />
        </res3:TransmisionDatos>
    </xsl:template>
    ...
    <xsl:template match="ns2:DatosEspecificos">
     ...
     <xsl:template match="//ns1:ValidarFirmaResponse/ValidarFirmaReturn">
    	<ns2:DatosEspecificos xmlns:ns2="http://intermediacion.redsara.es/scsp/esquemas/datosespecificos">
           <ValidarFirmaResponse>
           		<ValidarFirmaReturn><xsl:value-of select="." /></ValidarFirmaReturn>
           </ValidarFirmaResponse>
          </ns2:DatosEspecificos>
    </xsl:template>
    
 	<xsl:template match="ns1:ValidarFirmaResponse">
    </xsl:template>
