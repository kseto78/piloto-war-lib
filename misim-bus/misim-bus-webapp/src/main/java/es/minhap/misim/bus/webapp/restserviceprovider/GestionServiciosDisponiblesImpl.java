...
/**
 * Clase que implementa la logica de la peticion de consultaServiciosDisponibles
 * @author fescobaf
 * 
 */
public class GestionServiciosDisponiblesImpl implements GestionServiciosDisponibles {
	
	private static final Logger LOG = LoggerFactory.getLogger(GestionServiciosDisponiblesImpl.class);
	 ...
	 */
	@Override
	public String getServiciosDisponibles(MultivaluedMap<String,String>map) {
	...
	protected static final SOAPMessage generateSOAPFault() throws Exception {
		...
		return XMLUtils.dom2soap(XMLUtils.setPayloadFromObject(respuesta, Charset.forName("UTF-8"),
				RespuestaServiciosDisponibles.class));
	}
