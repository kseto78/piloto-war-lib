...
/**
 * Clase que implementa la logica de las peticones de gestion de notificaciones Push 
 * @author ralberoc
 *
 */
	...
	public String notificacionEstado(String notificacionId, String status, String idUsuario) {
		...
		try {
			...
			if ((null != username && !("").equals(username)) && (null != password && !("").equals(password))
				...
				response.setDetails("No se ha detectado alguno de los siguientes parametros obligatorios: Usuario, Password, idUsuario");
