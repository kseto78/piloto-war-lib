...
/**
 * Clase que implementa la logica del servicio EnvioMensajesService
 * @author ralberoc
 *
 */
@WebServiceProvider(portName = "EnvioMensajesServicePort", serviceName = "EnvioMensajesService", 
targetNamespace = "http://misim.redsara.es/misim-bus-webapp/", 
wsdlLocation = "WEB-INF/wsdl/recepcion-sim/enviarMensajesSIM.wsdl")
@ServiceMode(Mode.MESSAGE)
@Scope(value="request")
public class RecepcionMensajesSIMWSProvider extends WSProvider {
	...
	/**
	 * Metodo que implementa la logica de la peticion de enviarMensajesSIM
	 */
	@Override
