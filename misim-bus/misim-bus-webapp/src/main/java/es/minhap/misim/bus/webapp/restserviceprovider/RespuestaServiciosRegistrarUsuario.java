...
public class RespuestaServiciosRegistrarUsuario {
	...
	private ResponseServRegUsuarioStatusType status;
	 ...
	 * @return the status
	 */
	public ResponseServRegUsuarioStatusType getStatus() {
		return status;
	}
	 ...
	 *            the status to set
	 */
	public void setStatus(ResponseServRegUsuarioStatusType status) {
		this.status = status;
	}
}
